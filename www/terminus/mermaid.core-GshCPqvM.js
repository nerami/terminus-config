...
import { i as t, n, r } from "./src-BYM73fzN.js";
import { $ as i, C as a, E as o, I as s, L as c, N as l, P as u, Q as d, S as f, T as p, V as m, W as h, X as g, Z as _, _ as v, b as y, c as b, g as x, l as S, m as C, n as w, p as T, q as ee, r as te, t as ne, u as E } from "./chunk-CSCIHK7Q-AEjI_JHf.js";
import { S as re, a as ie, f as ae, g as D, h as oe, i as se, o as ce, v as le, x as ue, y as de } from "./chunk-5ZQYHXKU--OC8flB4.js";
import { t as fe } from "./chunk-WU5MYG2G-D_JlF4fa.js";
import { i as pe, o as me } from "./chunk-O5CBEL6O-Br3PEsWJ.js";
import "./chunk-BSJP7CBP-XfIAHpAE.js";
import "./chunk-L5ZTLDWV-DjGZgeb-.js";
import "./chunk-NZK2D7GU-C-653DhC.js";
import "./chunk-3OPIFGDE-Dg_fnvX1.js";
import "./chunk-KSCS5N6A-Da-PZJWw.js";
import { n as he } from "./chunk-LZXEDZCA-Cl3f5Z5P.js";
import { n as ge, t as _e } from "./chunk-XPW4576I-DUF0iLfs.js";
...
var Ke = "c4", qe = {
	...
	loader: /* @__PURE__ */ n(async () => {
		let { diagram: e } = await import("./c4Diagram-AAUBKEIU-Dwm_y6Kf.js");
		return {
			id: Ke,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ n(async () => {
		let { diagram: e } = await import("./flowDiagram-I6XJVG4X-C3Il9HBc.js");
		return {
			id: Je,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ n(async () => {
		let { diagram: e } = await import("./erDiagram-TEJ5UH35-X8nu6VWf.js");
		return {
			id: Qe,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ n(async () => {
		let { diagram: e } = await import("./gitGraphDiagram-PVQCEYII-Cd7TL9n3.js");
		return {
			id: et,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ n(async () => {
		let { diagram: e } = await import("./ganttDiagram-6RSMTGT7-BS3Q4-sC.js");
		return {
			id: nt,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ n(async () => {
		let { diagram: e } = await import("./infoDiagram-5YYISTIA-DlYMcUb3.js");
		return {
			id: it,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ n(async () => {
		let { diagram: e } = await import("./pieDiagram-4H26LBE5-BmldbVjh.js");
		return {
			id: ot,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ n(async () => {
		let { diagram: e } = await import("./quadrantDiagram-W4KKPZXB-CGi3Sgou.js");
		return {
			id: ct,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ n(async () => {
		let { diagram: e } = await import("./xychartDiagram-2RQKCTM6-M8bx2lxQ.js");
		return {
			id: ut,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ n(async () => {
		let { diagram: e } = await import("./requirementDiagram-4Y6WPE33-CNjp1TOG.js");
		return {
			id: ft,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ n(async () => {
		let { diagram: e } = await import("./sequenceDiagram-3UESZ5HK-BPCPWxiN.js");
		return {
			id: mt,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ n(async () => {
		let { diagram: e } = await import("./classDiagram-4FO5ZUOK-CTbrtDUV.js");
		return {
			id: gt,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ n(async () => {
		let { diagram: e } = await import("./classDiagram-v2-Q7XG4LA2-D9Ul3OvK.js");
		return {
			id: vt,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ n(async () => {
		let { diagram: e } = await import("./stateDiagram-AJRCARHV-Bru06CAJ.js");
		return {
			id: bt,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ n(async () => {
		let { diagram: e } = await import("./stateDiagram-v2-BHNVJYJU-CX6lAC18.js");
		return {
			id: St,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ n(async () => {
		let { diagram: e } = await import("./journeyDiagram-JHISSGLW-DTH2NtyU.js");
		return {
			id: wt,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ n(async () => {
		let { diagram: e } = await import("./timeline-definition-PNZ67QCA-B1IxMAkO.js");
		return {
			id: jt,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ n(async () => {
		let { diagram: e } = await import("./mindmap-definition-RKZ34NQL-BnPWOnD7.js");
		return {
			id: Nt,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ n(async () => {
		let { diagram: e } = await import("./kanban-definition-UN3LZRKU-DUeT-kUd.js");
		return {
			id: Ft,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ n(async () => {
		let { diagram: e } = await import("./sankeyDiagram-5OEKKPKP-D3DZw8qM.js");
		return {
			id: Lt,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ n(async () => {
		let { diagram: e } = await import("./diagram-LMA3HP47-e6SFrwEv.js");
		return {
			id: zt,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ n(async () => {
		let { diagram: e } = await import("./diagram-2AECGRRQ-CdT9MFPj.js");
		return {
			id: Vt,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ n(async () => {
		let { diagram: e } = await import("./blockDiagram-GPEHLZMM-Cow2D2QU.js");
		return {
			id: Ut,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ n(async () => {
		let { diagram: e } = await import("./diagram-5GNKFQAL-s5pRThCJ.js");
		return {
			id: Gt,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ n(async () => {
		let { diagram: e } = await import("./architectureDiagram-3BPJPVTR-DWUETImM.js");
		return {
			id: qt,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ n(async () => {
		let { diagram: e } = await import("./diagram-KO2AKTUF-C0g8j7z8.js");
		return {
			id: Yt,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ n(async () => {
		let { diagram: e } = await import("./ishikawaDiagram-YF4QCWOH-CC_uhCNn.js");
		return {
			id: Zt,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ n(async () => {
		let { diagram: e } = await import("./vennDiagram-CIIHVFJN-Ct95mNBj.js");
		return {
			id: $t,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ n(async () => {
		let { diagram: e } = await import("./diagram-OG6HWLK6-DKURThDH.js");
		return {
			id: tn,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ n(async () => {
		let { diagram: e } = await import("./wardleyDiagram-YWT4CUSO-E4_ooqtR.js");
		return {
			id: rn,
			diagram: e
		};
