...
var t = /* @__PURE__ */ e({
	...
	"\"": "&quot;",
	"'": "&#x27;"
}, o = /[&><"']/g, s = (e) => String(e).replace(o, (e) => a[e]), c = (e) => e.type === "ordgroup" || e.type === "color" ? e.body.length === 1 ? c(e.body[0]) : e : e.type === "font" ? c(e.body) : e, l = new Set([
	"mathord",
	"textord",
	"atom"
...
var Ce = class {
	...
	toNode() {
		...
		return this.italic > 0 && (t = document.createElement("span"), t.style.marginRight = A(this.italic)), this.classes.length > 0 && (t ||= document.createElement("span"), t.className = De(this.classes)), Object.keys(this.style).length > 0 && (t ||= document.createElement("span"), Object.assign(t.style, this.style)), t ? (t.appendChild(e), t) : e;
	}
	toMarkup() {
		var e = !1, t = "<span";
...
}, wn = new Set(["\\imath", "\\jmath"]), Tn = new Set(["mrow", "mtable"]), En = function(e, t, n) {
	...
	for (var i = [], a, o = 0; o < e.length; o++) {
		...
		if (s instanceof X && a instanceof X) {
			if (s.type === "mtext" && a.type === "mtext" && s.getAttribute("mathvariant") === a.getAttribute("mathvariant")) {
				...
				a.children.push(...s.children);
				continue;
			} else if (An(s) && a.type === "mn") {
				a.children.push(...s.children);
				continue;
			} else if (s.type === "mn" && An(a)) s.children = [...a.children, ...s.children], i.pop();
...
}, Yr = new Set(/* @__PURE__ */ "(,\\lparen,),\\rparen,[,\\lbrack,],\\rbrack,\\{,\\lbrace,\\},\\rbrace,\\lfloor,\\rfloor,⌊,⌋,\\lceil,\\rceil,⌈,⌉,<,>,\\langle,⟨,\\rangle,⟩,\\lt,\\gt,\\lvert,\\rvert,\\lVert,\\rVert,\\lgroup,\\rgroup,⟮,⟯,\\lmoustache,\\rmoustache,⎰,⎱,/,\\backslash,|,\\vert,\\|,\\Vert,\\uparrow,\\Uparrow,\\downarrow,\\Downarrow,\\updownarrow,\\Updownarrow,.".split(","));
function Xr(e) {
...
var fi = function(e, t) {
	...
	if (e.cols && e.cols.length > 0) {
		...
		for (var v = g; v < _; v++) {
			var y = p[v];
			y.type === "align" ? (f += pi[y.align], h && (m += "none "), h = !0) : y.type === "separator" && (h &&= (m += y.separator === "|" ? "solid " : "dashed ", !1));
		}
...
J({
	...
	mathmlBuilder: (e, t) => {
		for (var n = jn(e.body, t.withFont("mathrm")), r = !0, i = 0; i < n.length; i++) {
			var a = n[i];
			if (!(a instanceof Cn)) if (a instanceof X) switch (a.type) {
				case "mi":
				case "mn":
				case "mspace":
				case "mtext": break;
...
on({
	...
	htmlBuilder(e, t) {
		if (Hi.hasOwnProperty(e.text)) {
			...
			} else return G(["mspace", r], [Ft(e.text, e.mode, t)], t);
		} else if (Vi.hasOwnProperty(e.text)) return G(["mspace", Vi[e.text]], [], t);
...
$("\\char", function(e) {
	...
	else if (t.text === "`") if (t = e.popToken(), t.text[0] === "\\") i = t.text.charCodeAt(1);
...
var ma = {
	...
	consumeArg(e) {
		...
		do {
			...
			if (e && r) if ((o === 0 || o === 1 && e[s] === "{") && a.text === e[s]) {
				if (++s, s === e.length) {
					t.splice(-s, s);
					break;
				}
