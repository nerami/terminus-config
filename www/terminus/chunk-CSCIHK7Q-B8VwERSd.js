import { i as e, n as t, r as n, t as r } from "./src-nrT8XS4T.js";
...
var ce = Object.entries, le = Object.setPrototypeOf, ue = Object.isFrozen, de = Object.getPrototypeOf, fe = Object.getOwnPropertyDescriptor, w = Object.freeze, T = Object.seal, pe = Object.create, me = typeof Reflect < "u" && Reflect, he = me.apply, E = me.construct;
w ||= function(e) {
	return e;
}, T ||= function(e) {
	return e;
...
var ge = N(Array.prototype.forEach), _e = N(Array.prototype.lastIndexOf), ve = N(Array.prototype.pop), ye = N(Array.prototype.push), be = N(Array.prototype.splice), D = Array.isArray, xe = N(String.prototype.toLowerCase), Se = N(String.prototype.toString), Ce = N(String.prototype.match), we = N(String.prototype.replace), Te = N(String.prototype.indexOf), Ee = N(String.prototype.trim), De = N(Number.prototype.toString), O = N(Boolean.prototype.toString), Oe = typeof BigInt > "u" ? null : N(BigInt.prototype.toString), k = typeof Symbol > "u" ? null : N(Symbol.prototype.toString), A = N(Object.prototype.hasOwnProperty), j = N(Object.prototype.toString), M = N(RegExp.prototype.test), ke = P(TypeError);
function N(e) {
	return function(t) {
...
function F(e, t) {
	let n = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : xe;
	if (le && le(e, null), !D(t)) return e;
	let r = t.length;
	for (; r--;) {
		let i = t[r];
		if (typeof i == "string") {
...
function I(e) {
	...
	for (let r of ce(e)) {
		var n = oe(r, 2);
		let i = n[0], a = n[1];
		A(e, i) && (D(a) ? t[i] = Ae(a) : a && typeof a == "object" && a.constructor === Object ? t[i] = I(a) : t[i] = a);
	}
	return t;
}
function je(e) {
	switch (typeof e) {
		...
		case "boolean": return O(e);
		case "bigint": return Oe ? Oe(e) : "0";
		case "symbol": return k ? k(e) : "Symbol()";
...
var Ne = w(/* @__PURE__ */ "a.abbr.acronym.address.area.article.aside.audio.b.bdi.bdo.big.blink.blockquote.body.br.button.canvas.caption.center.cite.code.col.colgroup.content.data.datalist.dd.decorator.del.details.dfn.dialog.dir.div.dl.dt.element.em.fieldset.figcaption.figure.font.footer.form.h1.h2.h3.h4.h5.h6.head.header.hgroup.hr.html.i.img.input.ins.kbd.label.legend.li.main.map.mark.marquee.menu.menuitem.meter.nav.nobr.ol.optgroup.option.output.p.picture.pre.progress.q.rp.rt.ruby.s.samp.search.section.select.shadow.slot.small.source.spacer.span.strike.strong.style.sub.summary.sup.table.tbody.td.template.textarea.tfoot.th.thead.time.tr.track.tt.u.ul.var.video.wbr".split(".")), Pe = w(/* @__PURE__ */ "svg.a.altglyph.altglyphdef.altglyphitem.animatecolor.animatemotion.animatetransform.circle.clippath.defs.desc.ellipse.enterkeyhint.exportparts.filter.font.g.glyph.glyphref.hkern.image.inputmode.line.lineargradient.marker.mask.metadata.mpath.part.path.pattern.polygon.polyline.radialgradient.rect.stop.style.switch.symbol.text.textpath.title.tref.tspan.view.vkern".split(".")), Fe = w([
	"feBlend",
	"feColorMatrix",
	"feComponentTransfer",
	"feComposite",
	...
	"unknown",
	"use"
]), Le = w(/* @__PURE__ */ "math.menclose.merror.mfenced.mfrac.mglyph.mi.mlabeledtr.mmultiscripts.mn.mo.mover.mpadded.mphantom.mroot.mrow.ms.mspace.msqrt.mstyle.msub.msup.msubsup.mtable.mtd.mtext.mtr.munder.munderover.mprescripts".split(".")), Re = w([
	"maction",
	"maligngroup",
	"malignmark",
	"mlongdiv",
	...
	"mprescripts",
	"none"
]), ze = w(["#text"]), Be = w(/* @__PURE__ */ "accept.action.align.alt.autocapitalize.autocomplete.autopictureinpicture.autoplay.background.bgcolor.border.capture.cellpadding.cellspacing.checked.cite.class.clear.color.cols.colspan.command.commandfor.controls.controlslist.coords.crossorigin.datetime.decoding.default.dir.disabled.disablepictureinpicture.disableremoteplayback.download.draggable.enctype.enterkeyhint.exportparts.face.for.headers.height.hidden.high.href.hreflang.id.inert.inputmode.integrity.ismap.kind.label.lang.list.loading.loop.low.max.maxlength.media.method.min.minlength.multiple.muted.name.nonce.noshade.novalidate.nowrap.open.optimum.part.pattern.placeholder.playsinline.popover.popovertarget.popovertargetaction.poster.preload.pubdate.radiogroup.readonly.rel.required.rev.reversed.role.rows.rowspan.spellcheck.scope.selected.shape.size.sizes.slot.span.srclang.start.src.srcset.step.style.summary.tabindex.title.translate.type.usemap.valign.value.width.wrap.xmlns".split(".")), Ve = w(/* @__PURE__ */ "accent-height.accumulate.additive.alignment-baseline.amplitude.ascent.attributename.attributetype.azimuth.basefrequency.baseline-shift.begin.bias.by.class.clip.clippathunits.clip-path.clip-rule.color.color-interpolation.color-interpolation-filters.color-profile.color-rendering.cx.cy.d.dx.dy.diffuseconstant.direction.display.divisor.dur.edgemode.elevation.end.exponent.fill.fill-opacity.fill-rule.filter.filterunits.flood-color.flood-opacity.font-family.font-size.font-size-adjust.font-stretch.font-style.font-variant.font-weight.fx.fy.g1.g2.glyph-name.glyphref.gradientunits.gradienttransform.height.href.id.image-rendering.in.in2.intercept.k.k1.k2.k3.k4.kerning.keypoints.keysplines.keytimes.lang.lengthadjust.letter-spacing.kernelmatrix.kernelunitlength.lighting-color.local.marker-end.marker-mid.marker-start.markerheight.markerunits.markerwidth.maskcontentunits.maskunits.max.mask.mask-type.media.method.mode.min.name.numoctaves.offset.operator.opacity.order.orient.orientation.origin.overflow.paint-order.path.pathlength.patterncontentunits.patterntransform.patternunits.points.preservealpha.preserveaspectratio.primitiveunits.r.rx.ry.radius.refx.refy.repeatcount.repeatdur.restart.result.rotate.scale.seed.shape-rendering.slope.specularconstant.specularexponent.spreadmethod.startoffset.stddeviation.stitchtiles.stop-color.stop-opacity.stroke-dasharray.stroke-dashoffset.stroke-linecap.stroke-linejoin.stroke-miterlimit.stroke-opacity.stroke.stroke-width.style.surfacescale.systemlanguage.tabindex.tablevalues.targetx.targety.transform.transform-origin.text-anchor.text-decoration.text-rendering.textlength.type.u1.u2.unicode.values.viewbox.visibility.version.vert-adv-y.vert-origin-x.vert-origin-y.width.word-spacing.wrap.writing-mode.xchannelselector.ychannelselector.x.x1.x2.xmlns.y.y1.y2.z.zoomandpan".split(".")), He = w(/* @__PURE__ */ "accent.accentunder.align.bevelled.close.columnalign.columnlines.columnspacing.columnspan.denomalign.depth.dir.display.displaystyle.encoding.fence.frame.height.href.id.largeop.length.linethickness.lquote.lspace.mathbackground.mathcolor.mathsize.mathvariant.maxsize.minsize.movablelimits.notation.numalign.open.rowalign.rowlines.rowspacing.rowspan.rspace.rquote.scriptlevel.scriptminsize.scriptsizemultiplier.selection.separator.separators.stretchy.subscriptshift.supscriptshift.symmetric.voffset.width.xmlns".split(".")), Ue = w([
	"xlink:href",
	"xml:id",
	"xlink:title",
	"xml:space",
	"xmlns:xlink"
]), We = T(/{{[\w\W]*|^[\w\W]*}}/g), Ge = T(/<%[\w\W]*|^[\w\W]*%>/g), Ke = T(/\${[\w\W]*/g), qe = T(/^data-[\-\w.\u00B7-\uFFFF]+$/), Je = T(/^aria-[\-\w]+$/), Ye = T(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i), Xe = T(/^(?:\w+script|data):/i), Ze = T(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g), Qe = T(/^html$/i), $e = T(/^[a-z][.\w]*(-[.\w]+)+$/i), R = {
	element: 1,
	attribute: 2,
	text: 3,
	cdataSection: 4,
...
function rt() {
	let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : et(), t = (e) => rt(e);
	if (t.version = "3.4.7", t.removed = [], !e || !e.document || e.document.nodeType !== R.document || !e.Element) return t.isSupported = !1, t;
	let n = e.document, r = n, i = r.currentScript;
	e.DocumentFragment;
	let a = e.HTMLTemplateElement, o = e.Node, s = e.Element, c = e.NodeFilter;
	e.NamedNodeMap === void 0 && (e.NamedNodeMap || e.MozNamedAttrMap), e.HTMLFormElement;
	let l = e.DOMParser, u = e.trustedTypes, d = s.prototype, f = L(d, "cloneNode"), p = L(d, "remove"), m = L(d, "nextSibling"), h = L(d, "childNodes"), g = L(d, "parentNode"), ee = L(d, "shadowRoot"), te = L(d, "attributes"), _ = o && o.prototype ? L(o.prototype, "nodeType") : null, v = o && o.prototype ? L(o.prototype, "nodeName") : null;
	if (typeof a == "function") {
		let e = n.createElement("template");
		e.content && e.content.ownerDocument && (n = e.content.ownerDocument);
	}
	let y, b = "", x = n, ne = x.implementation, S = x.createNodeIterator, re = x.createDocumentFragment, ie = x.getElementsByTagName, ae = r.importNode, C = nt();
	t.isSupported = typeof ce == "function" && typeof g == "function" && ne && ne.createHTMLDocument !== void 0;
	let oe = We, se = Ge, le = Ke, ue = qe, de = Je, fe = Xe, T = Ze, me = $e, he = Ye, E = null, De = F({}, [
		...Ne,
		...Pe,
		...Fe,
		...Le,
	...
	})), j = null, N = null, P = Object.seal(pe(null, {
		tagCheck: {
			writable: !0,
			configurable: !1,
			enumerable: !0,
	...
	})), Ae = !0, it = !0, at = !1, ot = !0, st = !1, ct = !0, z = !1, lt = !1, ut = !1, dt = !1, ft = !1, pt = !1, B = !0, V = !1, H = "user-content-", U = !0, mt = !1, ht = {}, W = null, gt = F({}, [
		"annotation-xml",
		"audio",
		"colgroup",
		"desc",
		...
		"style",
		"xmlns"
	]), xt = "http://www.w3.org/1998/Math/MathML", St = "http://www.w3.org/2000/svg", G = "http://www.w3.org/1999/xhtml", Ct = G, wt = !1, Tt = null, Et = F({}, [
		xt,
		St,
		G
	], Se), Dt = F({}, [
		...
		if (q && q === e) return;
		(!e || typeof e != "object") && (e = {}), e = I(e), At = jt.indexOf(e.PARSER_MEDIA_TYPE) === -1 ? "text/html" : e.PARSER_MEDIA_TYPE, K = At === "application/xhtml+xml" ? Se : xe, E = A(e, "ALLOWED_TAGS") && D(e.ALLOWED_TAGS) ? F({}, e.ALLOWED_TAGS, K) : De, O = A(e, "ALLOWED_ATTR") && D(e.ALLOWED_ATTR) ? F({}, e.ALLOWED_ATTR, K) : Oe, Tt = A(e, "ALLOWED_NAMESPACES") && D(e.ALLOWED_NAMESPACES) ? F({}, e.ALLOWED_NAMESPACES, Se) : Et, yt = A(e, "ADD_URI_SAFE_ATTR") && D(e.ADD_URI_SAFE_ATTR) ? F(I(bt), e.ADD_URI_SAFE_ATTR, K) : bt, _t = A(e, "ADD_DATA_URI_TAGS") && D(e.ADD_DATA_URI_TAGS) ? F(I(vt), e.ADD_DATA_URI_TAGS, K) : vt, W = A(e, "FORBID_CONTENTS") && D(e.FORBID_CONTENTS) ? F({}, e.FORBID_CONTENTS, K) : gt, j = A(e, "FORBID_TAGS") && D(e.FORBID_TAGS) ? F({}, e.FORBID_TAGS, K) : I({}), N = A(e, "FORBID_ATTR") && D(e.FORBID_ATTR) ? F({}, e.FORBID_ATTR, K) : I({}), ht = A(e, "USE_PROFILES") ? e.USE_PROFILES && typeof e.USE_PROFILES == "object" ? I(e.USE_PROFILES) : e.USE_PROFILES : !1, Ae = e.ALLOW_ARIA_ATTR !== !1, it = e.ALLOW_DATA_ATTR !== !1, at = e.ALLOW_UNKNOWN_PROTOCOLS || !1, ot = e.ALLOW_SELF_CLOSE_IN_ATTR !== !1, st = e.SAFE_FOR_TEMPLATES || !1, ct = e.SAFE_FOR_XML !== !1, z = e.WHOLE_DOCUMENT || !1, dt = e.RETURN_DOM || !1, ft = e.RETURN_DOM_FRAGMENT || !1, pt = e.RETURN_TRUSTED_TYPE || !1, ut = e.FORCE_BODY || !1, B = e.SANITIZE_DOM !== !1, V = e.SANITIZE_NAMED_PROPS || !1, U = e.KEEP_CONTENT !== !1, mt = e.IN_PLACE || !1, he = Me(e.ALLOWED_URI_REGEXP) ? e.ALLOWED_URI_REGEXP : Ye, Ct = typeof e.NAMESPACE == "string" ? e.NAMESPACE : G, Dt = A(e, "MATHML_TEXT_INTEGRATION_POINTS") && e.MATHML_TEXT_INTEGRATION_POINTS && typeof e.MATHML_TEXT_INTEGRATION_POINTS == "object" ? I(e.MATHML_TEXT_INTEGRATION_POINTS) : F({}, [
			"mi",
			"mo",
			"mn",
			"ms",
			"mtext"
		]), Ot = A(e, "HTML_INTEGRATION_POINTS") && e.HTML_INTEGRATION_POINTS && typeof e.HTML_INTEGRATION_POINTS == "object" ? I(e.HTML_INTEGRATION_POINTS) : F({}, ["annotation-xml"]);
		let t = A(e, "CUSTOM_ELEMENT_HANDLING") && e.CUSTOM_ELEMENT_HANDLING && typeof e.CUSTOM_ELEMENT_HANDLING == "object" ? I(e.CUSTOM_ELEMENT_HANDLING) : pe(null);
		if (k = pe(null), A(t, "tagNameCheck") && Mt(t.tagNameCheck) && (k.tagNameCheck = t.tagNameCheck), A(t, "attributeNameCheck") && Mt(t.attributeNameCheck) && (k.attributeNameCheck = t.attributeNameCheck), A(t, "allowCustomizedBuiltInElements") && typeof t.allowCustomizedBuiltInElements == "boolean" && (k.allowCustomizedBuiltInElements = t.allowCustomizedBuiltInElements), st && (it = !1), ft && (dt = !0), ht && (E = F({}, ze), O = pe(null), ht.html === !0 && (F(E, Ne), F(O, Be)), ht.svg === !0 && (F(E, Pe), F(O, Ve), F(O, Ue)), ht.svgFilters === !0 && (F(E, Fe), F(O, Ve), F(O, Ue)), ht.mathMl === !0 && (F(E, Le), F(O, He), F(O, Ue))), P.tagCheck = null, P.attributeCheck = null, A(e, "ADD_TAGS") && (typeof e.ADD_TAGS == "function" ? P.tagCheck = e.ADD_TAGS : D(e.ADD_TAGS) && (E === De && (E = I(E)), F(E, e.ADD_TAGS, K))), A(e, "ADD_ATTR") && (typeof e.ADD_ATTR == "function" ? P.attributeCheck = e.ADD_ATTR : D(e.ADD_ATTR) && (O === Oe && (O = I(O)), F(O, e.ADD_ATTR, K))), A(e, "ADD_URI_SAFE_ATTR") && D(e.ADD_URI_SAFE_ATTR) && F(yt, e.ADD_URI_SAFE_ATTR, K), A(e, "FORBID_CONTENTS") && D(e.FORBID_CONTENTS) && (W === gt && (W = I(W)), F(W, e.FORBID_CONTENTS, K)), A(e, "ADD_FORBID_CONTENTS") && D(e.ADD_FORBID_CONTENTS) && (W === gt && (W = I(W)), F(W, e.ADD_FORBID_CONTENTS, K)), U && (E["#text"] = !0), z && F(E, [
			"html",
			"head",
			"body"
		]), E.table && (F(E, ["tbody"]), delete j.tbody), e.TRUSTED_TYPES_POLICY) {
		...
		} else y === void 0 && (y = tt(u, i)), y !== null && typeof b == "string" && (b = y.createHTML(""));
		(C.uponSanitizeElement.length > 0 || C.uponSanitizeAttribute.length > 0) && E === De && (E = I(E)), C.uponSanitizeAttribute.length > 0 && O === Oe && (O = I(O)), w && w(e), q = e;
	}, Pt = F({}, [
		...Pe,
		...Fe,
		...Ie
	]), Ft = F({}, [...Le, ...Re]), It = function(e) {
		let t = g(e);
		(!t || !t.tagName) && (t = {
			namespaceURI: Ct,
			tagName: "template"
		});
		let n = xe(e.tagName), r = xe(t.tagName);
		...
		if (n.removeAttribute(e), e === "is") if (dt || ft) try {
			Lt(n);
		} catch {}
		else try {
			n.setAttribute(e, "");
		...
		if (!t || !t.documentElement) {
			t = ne.createDocument(Ct, "template", null);
			try {
				t.documentElement.innerHTML = wt ? b : i;
			} catch {}
		}
		let a = t.body || t.documentElement;
		return e && r && a.insertBefore(n.createTextNode(r), a.childNodes[0] || null), Ct === G ? ie.call(t, z ? "html" : "body")[0] : z ? t.documentElement : a;
	}, X = function(e) {
		...
		e.normalize();
		let t = S.call(e.ownerDocument || e, e, c.SHOW_TEXT | c.SHOW_COMMENT | c.SHOW_CDATA_SECTION | c.SHOW_PROCESSING_INSTRUCTION, null), n = t.nextNode();
		for (; n;) {
			let e = n.data;
			ge([
				oe,
		...
		let t = v ? v(e) : null;
		return typeof t != "string" || K(t) !== "form" ? !1 : typeof e.nodeName != "string" || typeof e.textContent != "string" || typeof e.removeChild != "function" || e.attributes !== te(e) || typeof e.removeAttribute != "function" || typeof e.setAttribute != "function" || typeof e.namespaceURI != "string" || typeof e.insertBefore != "function" || typeof e.hasChildNodes != "function" || e.nodeType !== _(e) || e.childNodes !== h(e);
	}, Q = function(e) {
	...
	let Vt = function(e) {
		let n = null;
		if ($(C.beforeSanitizeElements, e, null), Z(e)) return Lt(e), !0;
		let r = K(e.nodeName);
		if ($(C.uponSanitizeElement, e, {
			tagName: r,
			allowedTags: E
		}), ct && e.hasChildNodes() && !Bt(e.firstElementChild) && M(/<[/\w!]/g, e.innerHTML) && M(/<[/\w!]/g, e.textContent) || ct && e.namespaceURI === G && r === "style" && Bt(e.firstElementChild) || e.nodeType === R.progressingInstruction || ct && e.nodeType === R.comment && M(/<[/\w]/g, e.data)) return Lt(e), !0;
		if (j[r] || !(P.tagCheck instanceof Function && P.tagCheck(r)) && !E[r]) {
			if (!j[r] && Wt(r) && (k.tagNameCheck instanceof RegExp && M(k.tagNameCheck, r) || k.tagNameCheck instanceof Function && k.tagNameCheck(r))) return !1;
			if (U && !W[r]) {
				let t = g(e), n = h(e);
				if (n && t) {
					let r = n.length;
		...
		return (_ ? _(e) : e.nodeType) === R.element && !It(e) || (r === "noscript" || r === "noembed" || r === "noframes") && M(/<\/no(script|embed|frames)/i, e.innerHTML) ? (Lt(e), !0) : (st && e.nodeType === R.text && (n = e.textContent, ge([
			oe,
			se,
			le
		], (e) => {
			n = we(n, e, " ");
		}), e.textContent !== n && (ye(t.removed, { element: e.cloneNode() }), e.textContent = n)), $(C.afterSanitizeElements, e, null), !1);
	}, Ht = function(e, t, r) {
		if (N[t] || B && (t === "id" || t === "name") && (r in n || r in J)) return !1;
		let i = O[t] || P.attributeCheck instanceof Function && P.attributeCheck(t, e);
		if (!(it && !N[t] && M(ue, t)) && !(Ae && M(de, t))) {
			if (!i || N[t]) {
				if (!(Wt(e) && (k.tagNameCheck instanceof RegExp && M(k.tagNameCheck, e) || k.tagNameCheck instanceof Function && k.tagNameCheck(e)) && (k.attributeNameCheck instanceof RegExp && M(k.attributeNameCheck, t) || k.attributeNameCheck instanceof Function && k.attributeNameCheck(t, e)) || t === "is" && k.allowCustomizedBuiltInElements && (k.tagNameCheck instanceof RegExp && M(k.tagNameCheck, r) || k.tagNameCheck instanceof Function && k.tagNameCheck(r)))) return !1;
			} else if (!yt[t] && !M(he, we(r, T, "")) && !((t === "src" || t === "xlink:href" || t === "href") && e !== "script" && Te(r, "data:") === 0 && _t[e]) && !(at && !M(fe, we(r, T, ""))) && r) return !1;
		}
		return !0;
	}, Ut = F({}, [
		"annotation-xml",
		...
		for (; i--;) {
			let a = n[i], o = a.name, s = a.namespaceURI, c = a.value, l = K(o), d = c, f = o === "value" ? d : Ee(d);
			if (r.attrName = l, r.attrValue = f, r.keepAttr = !0, r.forceKeepAttr = void 0, $(C.uponSanitizeAttribute, e, r), f = r.attrValue, V && (l === "id" || l === "name") && Te(f, H) !== 0 && (Y(o, e), f = H + f), ct && M(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i, f)) {
				Y(o, e);
				continue;
			}
			if (l === "attributename" && Ce(f, "href")) {
				Y(o, e);
				continue;
			}
			...
			if (y && typeof u == "object" && typeof u.getAttributeType == "function" && !s) switch (u.getAttributeType(p, l)) {
				case "TrustedHTML":
					f = y.createHTML(f);
					break;
				case "TrustedScriptURL":
					f = y.createScriptURL(f);
					break;
			}
			if (f !== d) try {
				s ? e.setAttributeNS(s, o, f) : e.setAttribute(o, f), Z(e) ? Lt(e) : ve(t.removed);
			} catch {
				Y(o, e);
			}
		}
		...
		let t = null, n = X(e);
		for ($(C.beforeSanitizeShadowDOM, e, null); t = n.nextNode();) if ($(C.uponSanitizeShadowNode, t, null), Vt(t), Gt(t), Q(t.content) && Kt(t.content), (_ ? _(t) : t.nodeType) === R.element) {
			let e = ee ? ee(t) : t.shadowRoot;
			Q(e) && (qt(e), Kt(e));
		}
		$(C.afterSanitizeShadowDOM, e, null);
	}, qt = function(e) {
		let t = _ ? _(e) : e.nodeType;
		if (t === R.element) {
			let t = ee ? ee(e) : e.shadowRoot;
			Q(t) && (qt(t), Kt(t));
		}
		...
		if (t === R.element) {
			let t = v ? v(e) : null;
			if (typeof t == "string" && K(t) === "template") {
				let t = e.content;
				Q(t) && qt(t);
			}
		}
	...
	return t.sanitize = function(e) {
		...
		if (wt = !e, wt && (e = "<!-->"), typeof e != "string" && !Bt(e) && (e = je(e), typeof e != "string")) throw ke("dirty is not a string, aborting");
		if (!t.isSupported) return e;
		if (lt || Nt(n), t.removed = [], typeof e == "string" && (mt = !1), mt) {
			let t = v ? v(e) : e.nodeName;
			if (typeof t == "string") {
				let e = K(t);
				if (!E[e] || j[e]) throw ke("root node is forbidden and cannot be sanitized in-place");
			}
			if (Z(e)) throw ke("root node is clobbered and cannot be sanitized in-place");
			qt(e);
		} else if (Bt(e)) i = Rt("<!---->"), a = i.ownerDocument.importNode(e, !0), a.nodeType === R.element && a.nodeName === "BODY" || a.nodeName === "HTML" ? i = a : i.appendChild(a), qt(a);
		else {
			if (!dt && !st && !z && e.indexOf("<") === -1) return y && pt ? y.createHTML(e) : e;
			if (i = Rt(e), !i) return dt ? null : pt ? b : "";
		}
		i && ut && Lt(i.firstChild);
		let c = X(mt ? e : i);
		for (; o = c.nextNode();) Vt(o), Gt(o), Q(o.content) && Kt(o.content);
		if (mt) return st && zt(e), e;
		if (dt) {
			if (st && zt(i), ft) for (s = re.call(i.ownerDocument); i.firstChild;) s.appendChild(i.firstChild);
			else s = i;
			return (O.shadowroot || O.shadowrootmode) && (s = ae.call(r, s, !0)), s;
		}
		let l = z ? i.outerHTML : i.innerHTML;
		return z && E["!doctype"] && i.ownerDocument && i.ownerDocument.doctype && i.ownerDocument.doctype.name && M(Qe, i.ownerDocument.doctype.name) && (l = "<!DOCTYPE " + i.ownerDocument.doctype.name + ">\n" + l), st && ge([
			oe,
			se,
			le
		], (e) => {
			l = we(l, e, " ");
		}), y && pt ? y.createHTML(l) : l;
	}, t.setConfig = function() {
		Nt(arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}), lt = !0;
	}, t.clearConfig = function() {
		q = null, lt = !1;
	}, t.isValidAttribute = function(e, t, n) {
		return q || Nt({}), Ht(K(e), K(t), n);
	}, t.addHook = function(e, t) {
		typeof t == "function" && ye(C[e], t);
	}, t.removeHook = function(e, t) {
		if (t !== void 0) {
			let n = _e(C[e], t);
			return n === -1 ? void 0 : be(C[e], n, 1)[0];
		}
		return ve(C[e]);
...
var it = rt(), at = /^-{3}\s*[\n\r](.*?)[\n\r]-{3}\s*[\n\r]+/s, ot = /%{2}{\s*(?:(\w+)\s*:|(\w+))\s*(?:(\w+)|((?:(?!}%{2}).|\r?\n)*))?\s*(?:}%{2})?/gi, st = /\s*%%.*\n/gm, ct = class extends Error {
	static {
...
}, z = {}, lt = /* @__PURE__ */ t(function(e, t) {
	e = e.replace(at, "").replace(ot, "").replace(st, "\n");
	for (let [n, { detector: r }] of Object.entries(z)) if (r(e, t)) return n;
	throw new ct(`No diagram type detected matching given configuration for text: ${e}`);
}, "detectType"), ut = /* @__PURE__ */ t((...e) => {
	for (let { id: t, detector: n, loader: r } of e) dt(t, n, r);
}, "registerLazyLoadedDiagrams"), dt = /* @__PURE__ */ t((e, t, r) => {
	z[e] && n.warn(`Detector with key ${e} already exists. Overwriting.`), z[e] = {
		detector: t,
		loader: r
	}, n.debug(`Detector with key ${e} added${r ? " with loader" : ""}`);
}, "addDetector"), ft = /* @__PURE__ */ t((e) => z[e].loader, "getDiagramLoader"), pt = /* @__PURE__ */ t((e, t, { depth: n = 2, clobber: r = !1 } = {}) => {
	let i = {
		depth: n,
		clobber: r
	};
...
}, "assignWithDepth"), B = pt, V = "#ffffff", H = "#f2f2f2", U = /* @__PURE__ */ t((e, t) => t ? x(e, {
	s: -40,
	l: 10
}) : x(e, {
	s: -40,
	...
	updateColors() {
		...
		this.vennTitleTextColor = this.vennTitleTextColor ?? this.titleColor, this.vennSetTextColor = this.vennSetTextColor ?? this.textColor, this.quadrant1Fill = this.quadrant1Fill || this.primaryColor, this.quadrant2Fill = this.quadrant2Fill || x(this.primaryColor, {
			r: 5,
			g: 5,
			b: 5
		}), this.quadrant3Fill = this.quadrant3Fill || x(this.primaryColor, {
	...
	venn: { ...J.venn }
}, Nt = /* @__PURE__ */ t((e, t = "") => Object.keys(e).reduce((n, r) => Array.isArray(e[r]) ? n : typeof e[r] == "object" && e[r] !== null ? [
	...n,
	t + r,
	...Nt(e[r], "")
] : [...n, t + r], []), "keyify"), Pt = new Set(Nt(Mt, "")), Ft = Mt, It = /* @__PURE__ */ t((e) => {
	if (n.debug("sanitizeDirective called with", e), !(typeof e != "object" || !e)) {
		...
		for (let t of Object.keys(e)) {
			if (n.debug("Checking key", t), t.startsWith("__") || t.includes("proto") || t.includes("constr") || !Pt.has(t) || e[t] == null) {
			...
			if (typeof e[t] == "object") {
				...
				} else n.debug("sanitizing object", t), It(e[t]);
				continue;
			}
			for (let r of [
				"themeCSS",
				"fontFamily",
				"altFontFamily"
			]) t.includes(r) && (n.debug("sanitizing css option", t), e[t] = Lt(e[t]));
		}
...
}, "sanitizeDirective"), Lt = /* @__PURE__ */ t((e) => {
	let t = 0, n = 0;
	for (let r of e) {
...
}, "sanitizeCss"), Y = Object.freeze(Ft), Rt = /* @__PURE__ */ t((e) => !(e === !1 || [
	"false",
	"null",
	"0"
].includes(String(e).trim().toLowerCase())), "evaluate"), X = B({}, Y), zt, Z = [], Q = B({}, Y), Bt = /* @__PURE__ */ t((e, t) => {
	let n = B({}, e), r = {};
	for (let e of t) Kt(e), r = B(r, e);
	if (n = B(n, r), r.theme && r.theme in q) {
		let e = B(B({}, zt).themeVariables || {}, r.themeVariables);
		n.theme && n.theme in q && (n.themeVariables = q[n.theme].getThemeVariables(e));
	}
	return Q = n, Qt(Q), Q;
}, "updateCurrentConfig"), $ = /* @__PURE__ */ t((e) => (X = B({}, Y), X = B(X, e), e.theme && q[e.theme] && (X.themeVariables = q[e.theme].getThemeVariables(e.themeVariables)), Bt(X, Z), X), "setSiteConfig"), Vt = /* @__PURE__ */ t((e) => {
	zt = B({}, e);
}, "saveConfigFromInitialize"), Ht = /* @__PURE__ */ t((e) => (X = B(X, e), Bt(X, Z), X), "updateSiteConfig"), Ut = /* @__PURE__ */ t(() => B({}, X), "getSiteConfig"), Wt = /* @__PURE__ */ t((e) => (Qt(e), B(Q, e), Gt()), "setConfig"), Gt = /* @__PURE__ */ t(() => B({}, Q), "getConfig"), Kt = /* @__PURE__ */ t((e) => {
	...
	Xt[e] || (n.warn(Yt[e]), Xt[e] = !0);
}, "issueWarning"), Qt = /* @__PURE__ */ t((e) => {
	e && (e.lazyLoadedDiagrams || e.loadExternalDiagramsAtStartup) && Zt("LAZY_LOAD_DEPRECATED");
}, "checkConfig"), $t = /* @__PURE__ */ t(() => {
	let e = {};
	zt && (e = B(e, zt));
	for (let t of Z) e = B(e, t);
	return e;
}, "getUserDefinedConfig"), en = /* @__PURE__ */ t((e) => (e.flowchart?.htmlLabels != null && Zt("FLOWCHART_HTML_LABELS_DEPRECATED"), Rt(e.htmlLabels ?? e.flowchart?.htmlLabels ?? !0)), "getEffectiveHtmlLabels"), tn = /<br\s*\/?>/gi, nn = /* @__PURE__ */ t((e) => e ? pn(e).replace(/\\n/g, "#br#").split("#br#") : [""], "getRows"), rn = /* @__PURE__ */ (() => {
	let e = !1;
	return () => {
		e ||= (an(), !0);
	};
...
function an() {
	...
	it.addHook("beforeSanitizeAttributes", (t) => {
		t.tagName === "A" && t.hasAttribute("target") && t.setAttribute(e, t.getAttribute("target") ?? "");
	}), it.addHook("afterSanitizeAttributes", (t) => {
...
t(an, "setupDompurifyHooks");
var on = /* @__PURE__ */ t((e) => (rn(), it.sanitize(e)), "removeScript"), sn = /* @__PURE__ */ t((e, t) => {
	if (en(t)) {
	...
	return e;
}, "sanitizeMore"), cn = /* @__PURE__ */ t((e, t) => e && (e = t.dompurifyConfig ? it.sanitize(sn(e, t), t.dompurifyConfig).toString() : it.sanitize(sn(e, t), { FORBID_TAGS: ["style"] }).toString(), e), "sanitizeText"), ln = /* @__PURE__ */ t((e, t) => typeof e == "string" ? cn(e, t) : e.flat().map((e) => cn(e, t)), "sanitizeTextOrArray"), un = /* @__PURE__ */ t((e) => tn.test(e), "hasBreaks"), dn = /* @__PURE__ */ t((e) => e.split(tn), "splitBreaks"), fn = /* @__PURE__ */ t((e) => e.replace(/#br#/g, "<br/>"), "placeholderToBreak"), pn = /* @__PURE__ */ t((e) => e.replace(tn, "#br#"), "breakToPlaceholder"), mn = /* @__PURE__ */ t((e) => {
	let t = "";
...
}, "getUrl"), hn = /* @__PURE__ */ t(function(...e) {
	let t = e.filter((e) => !isNaN(e));
	return Math.max(...t);
}, "getMax"), gn = /* @__PURE__ */ t(function(...e) {
	let t = e.filter((e) => !isNaN(e));
	return Math.min(...t);
}, "getMin"), _n = /* @__PURE__ */ t(function(e) {
	let t = e.split(/(,)/), n = [];
	...
	return n.join("");
}, "parseGenericTypes"), vn = /* @__PURE__ */ t((e, t) => Math.max(0, e.split(t).length - 1), "countOccurrence"), yn = /* @__PURE__ */ t((e, t) => {
	let n = vn(e, "~"), r = vn(t, "~");
	return n === 1 && r === 1;
}, "shouldCombineSets"), bn = /* @__PURE__ */ t((e) => {
	let t = vn(e, "~"), n = !1;
	if (t <= 1) return e;
...
}, "processSet"), xn = /* @__PURE__ */ t(() => window.MathMLElement !== void 0, "isMathMLSupported"), Sn = /\$\$(.*)\$\$/g, Cn = /* @__PURE__ */ t((e) => (e.match(Sn)?.length ?? 0) > 0, "hasKatex"), wn = /* @__PURE__ */ t(async (e, t) => {
	...
	return n.remove(), r;
}, "calculateMathMLDimensions"), Tn = /* @__PURE__ */ t(async (e, t) => {
	if (!Cn(e)) return e;
	if (!(xn() || t.legacyMathML || t.forceLegacyMathML)) return e.replace(Sn, "MathML is unsupported in this environment.");
	{
		let { default: n } = await import("./katex-Bz_81i-Z.js").then((e) => e.n), r = t.forceLegacyMathML || !xn() && t.legacyMathML ? "htmlAndMathml" : "mathml";
...
}, "renderKatexUnsanitized"), En = /* @__PURE__ */ t(async (e, t) => cn(await Tn(e, t), t), "renderKatexSanitized"), Dn = {
	getRows: nn,
	sanitizeText: cn,
	...
	getMax: hn,
	getMin: gn
}, On = /* @__PURE__ */ t(function(e, t) {
	for (let n of t) e.attr(n[0], n[1]);
}, "d3Attrs"), kn = /* @__PURE__ */ t(function(e, t, n) {
	let r = /* @__PURE__ */ new Map();
	return n ? (r.set("width", "100%"), r.set("style", `max-width: ${t}px;`)) : (r.set("height", e), r.set("width", t)), r;
}, "calculateSvgSizeAttrs"), An = /* @__PURE__ */ t(function(e, t, n, r) {
	On(e, kn(t, n, r));
}, "configureSvgSize"), jn = /* @__PURE__ */ t(function(e, t, r, i) {
	let a = t.node().getBBox(), o = a.width, s = a.height;
	n.info(`SVG bounds: ${o}x${s}`, a);
	let c = 0, l = 0;
	n.info(`Graph bounds: ${c}x${l}`, e), c = o + r * 2, l = s + r * 2, n.info(`Calculated bounds: ${c}x${l}`), An(t, l, c, i);
...
t(Nn, "cssStyleSheetToString");
var Pn = /* @__PURE__ */ t((e, t, r, i) => {
	let a = "";
...
var Rn = "", zn = "", Bn = "", Vn = /* @__PURE__ */ t((e) => cn(e, Gt()), "sanitizeText"), Hn = /* @__PURE__ */ t(() => {
	Rn = "", Bn = "", zn = "";
}, "clear"), Un = /* @__PURE__ */ t((e) => {
	Rn = Vn(e).replace(/^\s+/g, "");
}, "setAccTitle"), Wn = /* @__PURE__ */ t(() => Rn, "getAccTitle"), Gn = /* @__PURE__ */ t((e) => {
	Bn = Vn(e).replace(/\n\s+/g, "\n");
}, "setAccDescription"), Kn = /* @__PURE__ */ t(() => Bn, "getAccDescription"), qn = /* @__PURE__ */ t((e) => {
	zn = Vn(e);
}, "setDiagramTitle"), Jn = /* @__PURE__ */ t(() => zn, "getDiagramTitle"), Yn = n, Xn = e, Zn = Gt, Qn = Wt, $n = Y, er = /* @__PURE__ */ t((e) => cn(e, Zn()), "sanitizeText"), tr = jn, nr = /* @__PURE__ */ t(() => Ln, "getCommonDb"), rr = {}, ir = /* @__PURE__ */ t((e, t, n) => {
	rr[e] && Yn.warn(`Diagram with id ${e} already registered. Overwriting.`), rr[e] = t, n && dt(e, n), Fn(e, t.styles), t.injectUtils?.(Yn, Xn, Zn, er, tr, nr(), () => {});
}, "registerDiagram"), ar = /* @__PURE__ */ t((e) => {
...
//#endregion
export { it as $, Cn as A, er as B, ft as C, vt as D, Ut as E, En as F, Qn as G, Gn as H, Jt as I, jn as J, qn as K, Lt as L, _n as M, ir as N, mn as O, ut as P, Ht as Q, It as R, ar as S, en as T, Un as U, Vt as V, Wt as W, In as X, tr as Y, q as Z, at as _, Hn as a, m as at, Gt as b, An as c, $n as d, b as et, Ft as f, Rt as g, ot as h, wn as i, g as it, tn as j, $t as k, Nn as l, z as m, qt as n, v as nt, Ln as o, a as ot, lt as p, $ as q, B as r, _ as rt, Dn as s, ct as t, y as tt, Y as u, Kn as v, Jn as w, Zn as x, Wn as y, cn as z };
