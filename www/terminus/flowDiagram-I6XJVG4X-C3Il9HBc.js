...
import { $ as r, G as i, H as a, K as o, U as s, a as c, d as l, it as u, s as d, v as f, w as ee, x as p, y as m } from "./chunk-CSCIHK7Q-AEjI_JHf.js";
import { t as h } from "./channel-BVcjG-uI.js";
import { c as g, g as _ } from "./chunk-5ZQYHXKU--OC8flB4.js";
import "./chunk-O5CBEL6O-Br3PEsWJ.js";
import { t as te } from "./chunk-FMBD7UC4-Dag3b6ut.js";
import "./chunk-BSJP7CBP-XfIAHpAE.js";
import "./chunk-L5ZTLDWV-DjGZgeb-.js";
import { t as ne } from "./chunk-ND2GUHAM-UviPDEk1.js";
import { t as re } from "./chunk-55IACEB6-DgbZ_hR3.js";
import { t as v } from "./chunk-2J33WTMH-Dok3JTva.js";
import "./chunk-NZK2D7GU-C-653DhC.js";
import { o as y } from "./chunk-3OPIFGDE-Dg_fnvX1.js";
import "./chunk-KSCS5N6A-Da-PZJWw.js";
import { r as b, t as x } from "./chunk-LZXEDZCA-Cl3f5Z5P.js";
import { n as S, t as C } from "./chunk-XPW4576I-DUF0iLfs.js";
...
var w = "flowchart-", T = class {
	...
	addVertex(e, t, r, i, a, o, s = {}, c) {
		...
		if (f === void 0 && (t === void 0 && r === void 0 && i != null && n.warn(`Style applied to unknown node "${e}". This may indicate a typo. The node will be created automatically.`), f = {
			...
			styles: [],
			classes: []
		}, this.vertices.set(e, f)), this.vertexCounter++, t === void 0 ? f.text === void 0 && (f.text = e) : (this.config = p(), d = this.sanitizeText(t.text.trim()), f.labelType = t.type, d.startsWith("\"") && d.endsWith("\"") && (d = d.substring(1, d.length - 1)), f.text = d), r !== void 0 && (f.type = r), i?.forEach((e) => {
			f.styles.push(e);
		}), a?.forEach((e) => {
			f.classes.push(e);
...
You have to call mermaid.initialize.`);
	...
	setupToolTips(t) {
		let n = ne();
		e(t).select("svg").selectAll("g.node").on("mouseover", (t) => {
			let i = e(t.currentTarget), a = i.attr("title");
			if (a === null) return;
			let o = t.currentTarget?.getBoundingClientRect();
			n.transition().duration(200).style("opacity", ".9"), n.text(i.attr("title")).style("left", window.scrollX + o.left + (o.right - o.left) / 2 + "px").style("top", window.scrollY + o.bottom + "px"), n.html(r.sanitize(a)), i.classed("hover", !0);
		}).on("mouseout", (t) => {
			n.transition().duration(500).style("opacity", 0), e(t.currentTarget).classed("hover", !1);
		});
	}
	clear(e = "gen-2") {
