...
import { C as t, D as n, E as r, F as i, O as a, P as o, S as s, T as c, a as l, b as u, g as d, k as f, n as p, t as m } from "./chunk-JAPRZBRM-UOL0ghSO.js";
...
function dn(e, t, n) {
	let r = S(n, t, !0);
	return !r || r.type !== "comment" && !(r.type === "text" && d(r.value.charAt(0)));
}
function fn(e, t, n) {
	let r = S(n, t);
...
function kn(e) {
	let t = S(e, -1, !0);
	return !t || t.type !== "comment" && !(t.type === "text" && d(t.value.charAt(0))) && !(t.type === "element" && (t.tagName === "meta" || t.tagName === "link" || t.tagName === "script" || t.tagName === "style" || t.tagName === "template"));
}
function An(e, t, n) {
...
function Nn(e, t, n, r) {
	let i = r.schema, o = i.space === "svg" ? !1 : r.settings.omitOptionalTags, s = i.space === "svg" ? r.settings.closeEmptyElements : r.settings.voids.includes(e.tagName.toLowerCase()), c = [], l;
	i.space === "html" && e.tagName === "svg" && (r.schema = a);
	let u = Pn(r, e.properties), d = r.all(i.space === "html" && e.tagName === "template" ? e.content : e);
	return r.schema = i, d && (s = !1), (u || !o || !En(e, t, n)) && (c.push("<", e.tagName, u ? " " + u : ""), s && (i.space === "svg" || r.settings.closeSelfClosing) && (l = u.charAt(u.length - 1), (!r.settings.tightSelfClosing || l === "/" || l && l !== "\"" && l !== "'") && c.push(" "), c.push("/")), c.push(">")), c.push(d), !s && (!o || !un(e, t, n)) && c.push("</" + e.tagName + ">"), c.join("");
}
function Pn(e, t) {
	let n = [], r = -1, i;
	if (t) {
...
function Fn(e, t, n) {
	let i = f(e.schema, t), a = e.settings.allowParseErrors && e.schema.space === "html" ? 0 : 1, o = +!e.settings.allowDangerousCharacters, s = e.quote, l;
	...
	let d = x(i.attribute, Object.assign({}, e.settings.characterReferences, { subset: Mn.name[a][o] }));
	return n === !0 || (n = Array.isArray(n) ? (i.commaSeparated ? r : c)(n, { padLeft: !e.settings.tightCommaSeparatedLists }) : String(n), e.settings.collapseEmptyAttributes && !n) ? d : (e.settings.preferUnquoted && (l = x(n, Object.assign({}, e.settings.characterReferences, {
		attribute: !0,
		subset: Mn.unquoted[a][o]
	}))), l !== n && (e.settings.quoteSmart && u(n, s) > u(n, e.alternative) && (s = e.alternative), l = s + x(n, Object.assign({}, e.settings.characterReferences, {
		subset: (s === "'" ? Mn.single : Mn.double)[a][o],
		attribute: !0
	})) + s), d + (l && "=" + l));
}
//#endregion
...
var bi = [
	...
	},
	{
		id: "angular-html",
		name: "Angular HTML",
		import: (() => import("./angular-html-BoIKMHMf.js").then((e) => e.n))
	},
	{
		id: "angular-ts",
		name: "Angular TypeScript",
		import: (() => import("./angular-ts-gSFYAgcE.js"))
	},
	{
		id: "apache",
		name: "Apache Conf",
	...
	},
	{
		id: "astro",
		name: "Astro",
		import: (() => import("./astro-CChFNNpm.js"))
	},
	{
		id: "awk",
		name: "AWK",
	...
	},
	{
		id: "blade",
		name: "Blade",
		import: (() => import("./blade-CrRY5fsz.js"))
	},
	{
		id: "bsl",
		name: "1C (Enterprise)",
	...
	},
	{
		id: "c",
		name: "C",
		import: (() => import("./c-ClbfIB_d.js").then((e) => e.n))
	},
	{
		id: "c3",
		name: "C3",
	...
	},
	{
		id: "cobol",
		name: "COBOL",
		import: (() => import("./cobol-DkBQ7rf0.js"))
	},
	{
		id: "codeowners",
		name: "CODEOWNERS",
	...
	},
	{
		...
		import: (() => import("./coffee-BuVGpQKD.js"))
	},
	{
		id: "common-lisp",
		name: "Common Lisp",
	...
	},
	{
		...
		name: "C++",
		aliases: ["c++"],
		import: (() => import("./cpp-DbobV4EP.js").then((e) => e.n))
	},
	{
		id: "crystal",
		name: "Crystal",
		import: (() => import("./crystal-CF02BPBU.js"))
	},
	{
		id: "csharp",
		name: "C#",
	...
	},
	{
		id: "css",
		name: "CSS",
		import: (() => import("./css-CCW7AE3r.js").then((e) => e.n))
	},
	{
		id: "csv",
		name: "CSV",
	...
	},
	{
		id: "edge",
		name: "Edge",
		import: (() => import("./edge-WOkmkBo5.js"))
	},
	{
		id: "elixir",
		name: "Elixir",
		import: (() => import("./elixir-CeMkM1Yv.js"))
	},
	{
		id: "elm",
		name: "Elm",
		import: (() => import("./elm-DQJkmwej.js"))
	},
	{
		id: "emacs-lisp",
		name: "Emacs Lisp",
	...
	},
	{
		...
		import: (() => import("./git-rebase-D4OSdVrH.js"))
	},
	{
		id: "gleam",
		name: "Gleam",
	...
	},
	{
		...
		name: "Glimmer JS",
		aliases: ["gjs"],
		import: (() => import("./glimmer-js-Bniy8rxq.js"))
	},
	{
		id: "glimmer-ts",
		name: "Glimmer TS",
		aliases: ["gts"],
		import: (() => import("./glimmer-ts-BYOu6EfE.js"))
	},
	{
		id: "glsl",
		name: "GLSL",
		import: (() => import("./glsl-Csqy5aZP.js").then((e) => e.n))
	},
	{
		id: "gn",
		name: "GN",
	...
	},
	{
		...
		name: "GraphQL",
		aliases: ["gql"],
		import: (() => import("./graphql-CB6ueepf.js").then((e) => e.n))
	},
	{
		id: "groovy",
		name: "Groovy",
	...
	},
	{
		id: "hack",
		name: "Hack",
		import: (() => import("./hack-Ba1U7xZc.js"))
	},
	{
		id: "haml",
		name: "Ruby Haml",
		import: (() => import("./haml-CQ59inbD.js").then((e) => e.n))
	},
	{
		id: "handlebars",
		name: "Handlebars",
		aliases: ["hbs"],
		import: (() => import("./handlebars-Bcx-kOhm.js"))
	},
	{
		id: "haskell",
		name: "Haskell",
	...
	},
	{
		id: "html",
		name: "HTML",
		import: (() => import("./html-DJJxpI4k.js").then((e) => e.n))
	},
	{
		id: "html-derivative",
		name: "HTML (Derivative)",
		import: (() => import("./html-derivative-lEsT6Qv0.js"))
	},
	{
		id: "http",
		name: "HTTP",
		import: (() => import("./http-VfeGBfaE.js"))
	},
	{
		id: "hurl",
		name: "Hurl",
		import: (() => import("./hurl-DAsGpodc.js"))
	},
	{
		id: "hxml",
		name: "HXML",
	...
	},
	{
		id: "java",
		name: "Java",
		import: (() => import("./java-DRThF2Zj.js").then((e) => e.n))
	},
	{
		id: "javascript",
		name: "JavaScript",
		...
		import: (() => import("./javascript-CHshMEqR.js").then((e) => e.n))
	},
	{
		id: "jinja",
		name: "Jinja",
		import: (() => import("./jinja-D8BtWV2J.js"))
	},
	{
		id: "jison",
		name: "Jison",
		import: (() => import("./jison-kni7K3ex.js"))
	},
	{
		id: "json",
		name: "JSON",
		import: (() => import("./json-BRRpMCPI.js").then((e) => e.n))
	},
	{
		id: "json5",
		name: "JSON5",
	...
	},
	{
		id: "jsx",
		name: "JSX",
		import: (() => import("./jsx-hKb9gVbN.js").then((e) => e.n))
	},
	{
		id: "julia",
		name: "Julia",
		aliases: ["jl"],
		import: (() => import("./julia-eqNaOxNy.js"))
	},
	{
		id: "just",
		name: "Just",
		import: (() => import("./just-VKRyirXO.js"))
	},
	{
		id: "kdl",
		name: "KDL",
	...
	},
	{
		id: "latex",
		name: "LaTeX",
		import: (() => import("./latex-BoBFUT8c.js"))
	},
	{
		id: "lean",
		name: "Lean 4",
	...
	},
	{
		id: "liquid",
		name: "Liquid",
		import: (() => import("./liquid-DTaTuUEk.js"))
	},
	{
		id: "llvm",
		name: "LLVM IR",
	...
	},
	{
		id: "lua",
		name: "Lua",
		import: (() => import("./lua-_Y7Wl3wX.js").then((e) => e.n))
	},
	{
		id: "luau",
		name: "Luau",
	...
	},
	{
		id: "marko",
		name: "Marko",
		import: (() => import("./marko-BxHNaKzg.js"))
	},
	{
		id: "matlab",
		name: "MATLAB",
	...
	},
	{
		id: "nginx",
		name: "Nginx",
		import: (() => import("./nginx-CfrrNkt2.js"))
	},
	{
		id: "nim",
		name: "Nim",
		import: (() => import("./nim-Dcv9jy1R.js"))
	},
	{
		id: "nix",
		name: "Nix",
	...
	},
	{
		id: "perl",
		name: "Perl",
		import: (() => import("./perl-l_o525lT.js"))
	},
	{
		id: "php",
		name: "PHP",
		import: (() => import("./php-DCyiQGmT.js"))
	},
	{
		id: "pkl",
		name: "Pkl",
	...
	},
	{
		id: "r",
		name: "R",
		import: (() => import("./r-DN4hLylo.js").then((e) => e.n))
	},
	{
		id: "racket",
		name: "Racket",
	...
	},
	{
		id: "razor",
		name: "ASP.NET Razor",
		import: (() => import("./razor-DjXYqYUT.js"))
	},
	{
		id: "reg",
	...
	},
	{
		...
		name: "RegExp",
		aliases: ["regex"],
		import: (() => import("./regexp-DTr_HZ8d.js").then((e) => e.n))
	},
	{
		id: "rel",
		name: "Rel",
	...
	},
	{
		...
		import: (() => import("./rst-BEsVAvZB.js"))
	},
	{
		id: "ruby",
		name: "Ruby",
		aliases: ["rb"],
		import: (() => import("./ruby-BTj3TNfS.js"))
	},
	{
		id: "rust",
		name: "Rust",
	...
	},
	{
		id: "scss",
		name: "SCSS",
		import: (() => import("./scss-D2R5IYXu.js").then((e) => e.n))
	},
	{
		id: "sdbl",
		name: "1C (Query)",
	...
	},
	{
		...
		import: (() => import("./shellscript-K9amGyXm.js").then((e) => e.n))
	},
	{
		id: "shellsession",
		name: "Shell Session",
		aliases: ["console"],
		import: (() => import("./shellsession-DNBO-2_A.js"))
	},
	{
		id: "smalltalk",
		name: "Smalltalk",
	...
	},
	{
		id: "sql",
		name: "SQL",
		import: (() => import("./sql-BAjtQBk2.js").then((e) => e.n))
	},
	{
		id: "ssh-config",
		name: "SSH Config",
	...
	},
	{
		id: "stata",
		name: "Stata",
		import: (() => import("./stata-CKBiq2iZ.js"))
	},
	{
		id: "stylus",
		name: "Stylus",
	...
	},
	{
		...
		name: "SurrealQL",
		aliases: ["surql"],
		import: (() => import("./surrealql-BRgAkFae.js"))
	},
	{
		id: "svelte",
		name: "Svelte",
		import: (() => import("./svelte-Bx60ChsM.js"))
	},
	{
		id: "swift",
		name: "Swift",
	...
	},
	{
		id: "templ",
		name: "Templ",
		import: (() => import("./templ-DBMSg9P9.js"))
	},
	{
		id: "terraform",
		name: "Terraform",
	...
	},
	{
		...
		aliases: ["lit"],
		import: (() => import("./ts-tags-B_Gvylj_.js"))
	},
	{
		id: "tsv",
		name: "TSV",
	...
	},
	{
		id: "tsx",
		name: "TSX",
		import: (() => import("./tsx-DfZTyzBa.js").then((e) => e.n))
	},
	{
		id: "turtle",
		name: "Turtle",
	...
	},
	{
		id: "twig",
		name: "Twig",
		import: (() => import("./twig-DQUUzNVM.js"))
	},
	{
		id: "typescript",
		name: "TypeScript",
		...
		import: (() => import("./typescript-AD1MzfVK.js").then((e) => e.n))
	},
	{
		id: "typespec",
		name: "TypeSpec",
	...
	},
	{
		id: "vue",
		name: "Vue",
		import: (() => import("./vue-C7_bpyR5.js"))
	},
	{
		id: "vue-html",
		name: "Vue HTML",
		import: (() => import("./vue-html-CMBSy0ry.js"))
	},
	{
		id: "vue-vine",
		name: "Vue Vine",
		import: (() => import("./vue-vine-D0juFqkg.js"))
	},
	{
		id: "vyper",
		name: "Vyper",
	...
	},
	{
		id: "xml",
		name: "XML",
		import: (() => import("./xml-CoJW54bf.js").then((e) => e.n))
	},
	{
		id: "xsl",
		name: "XSL",
		import: (() => import("./xsl-C57oaHp0.js"))
	},
	{
		id: "yaml",
		name: "YAML",
		aliases: ["yml"],
		import: (() => import("./yaml-CU8p-FtW.js").then((e) => e.n))
	},
	{
		id: "zenscript",
		name: "ZenScript",
...
var Z = /* @__PURE__ */ e(i(), 1), Q = o(), sc = l("block", "before:content-[counter(line)]", "before:inline-block", "before:[counter-increment:line]", "before:w-4", "before:mr-4", "before:text-[13px]", "before:text-right", "before:text-muted-foreground/50", "before:font-mono", "before:select-none"), cc = (0, Z.memo)(({ children: e, result: t, language: n, className: r, ...i }) => {
	let a = (0, Z.useMemo)(() => ({
		backgroundColor: t.bg,
		color: t.fg
	}), [t.bg, t.fg]);
	return (0, Q.jsx)("pre", {
		className: l(r, "p-4 text-sm dark:bg-(--shiki-dark-bg)!"),
		"data-language": n,
		...
		children: (0, Q.jsx)("code", {
			...
			children: t.tokens.map((e, t) => (0, Q.jsx)("span", {
				className: sc,
...
}, (e, t) => e.result === t.result && e.language === t.language && e.className === t.className), lc = ({ className: e, language: t, style: n, ...r }) => (0, Q.jsx)("div", {
	className: l("my-4 w-full overflow-hidden rounded-xl border border-border", e),
	"data-language": t,
	...
	let { shikiTheme: a } = (0, Z.useContext)(m), [o, s] = (0, Z.useState)((0, Z.useMemo)(() => ({
		bg: "transparent",
		fg: "inherit",
		tokens: e.split("\n").map((e) => [{
			content: e,
