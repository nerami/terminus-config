...
import { H as r, U as i, c as a, r as o, s, v as l, x as u, y as d, z as f } from "./chunk-CSCIHK7Q-AEjI_JHf.js";
import { t as p } from "./dist-EOrTCqNZ.js";
import { _ as m, n as h, r as g } from "./chunk-5ZQYHXKU--OC8flB4.js";
import { a as _, s as v } from "./chunk-ND2GUHAM-UviPDEk1.js";
...
var ze = {
	...
	draw: /* @__PURE__ */ t(function(t, r, i, o) {
		...
		s === "sandbox" && (l = e("#i" + r));
		let d = e(s === "sandbox" ? l.nodes()[0].contentDocument.body : "body"), f = o.db;
		o.db.setWrap(Z.wrap), Ee = f.getC4ShapeInRow(), De = f.getC4BoundaryInRow(), n.debug(`C:${JSON.stringify(Z, null, 2)}`);
		let p = s === "sandbox" ? d.select(`[id="${r}"]`) : e(`[id="${r}"]`);
		...
		let y = h ? 60 : 0;
		p.attr("viewBox", g.startx - Z.diagramMarginX + " -" + (Z.diagramMarginY + y) + " " + v + " " + (_ + y)), n.debug("models:", g);
	}, "draw")
}, Be = {
	parser: x,
	db: ue,
