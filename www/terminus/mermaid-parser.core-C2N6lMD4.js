...
l(sn, {
	...
	AbstractThreadedAsyncParser: () => MN,
	AstUtils: () => wn,
	BiMap: () => hM,
	Cancellation: () => Z,
	...
	CstNodeBuilder: () => QA,
	CstUtils: () => cn,
	DEFAULT_TOKENIZE_OPTIONS: () => ZM,
	DONE_RESULT: () => xn,
	DatatypeSymbol: () => ij,
	DefaultAstNodeDescriptionProvider: () => BM,
	DefaultAstNodeLocator: () => HM,
	DefaultAsyncParser: () => jN,
	DefaultCommentProvider: () => AN,
	DefaultConfigurationProvider: () => WM,
	DefaultDocumentBuilder: () => qM,
	DefaultDocumentValidator: () => FM,
	DefaultHydrator: () => FN,
	DefaultIndexManager: () => JM,
	DefaultJsonSerializer: () => kM,
	DefaultLangiumDocumentFactory: () => sM,
	DefaultLangiumDocuments: () => cM,
	DefaultLangiumProfiler: () => nP,
	DefaultLexer: () => QM,
	DefaultLexerErrorMessageProvider: () => XM,
	DefaultLinker: () => uM,
	DefaultNameProvider: () => fM,
	DefaultReferenceDescriptionProvider: () => VM,
	DefaultReferences: () => pM,
	DefaultScopeComputation: () => gM,
	DefaultScopeProvider: () => EM,
	DefaultServiceRegistry: () => AM,
	DefaultTokenBuilder: () => Lj,
	DefaultValueConverter: () => Rj,
	DefaultWorkspaceLock: () => PN,
	DefaultWorkspaceManager: () => YM,
	Deferred: () => Jj,
	Disposable: () => KM,
	DisposableCache: () => xM,
	DocumentCache: () => wM,
	DocumentState: () => Q,
	DocumentValidator: () => zM,
	EMPTY_SCOPE: () => bM,
	EMPTY_STREAM: () => bn,
	EmptyFileSystem: () => ZN,
	...
	UriTrie: () => oM,
	UriUtils: () => aM,
	VALIDATE_EACH_NODE: () => PM,
	ValidationCategory: () => MM,
	ValidationRegistry: () => NM,
	ValueConverter: () => zj,
	WorkspaceCache: () => TM,
	assertCondition: () => sa,
	assertUnreachable: () => oa,
	createCompletionParser: () => Pj,
	createDefaultCoreModule: () => IN,
	createDefaultSharedCoreModule: () => LN,
	...
	diagnosticData: () => jM,
	eagerLoad: () => BN,
	getDiagnosticRange: () => IM,
	indentationBuilderDefaultOptions: () => GN,
	inject: () => $,
	interruptAndCheck: () => qj,
	isAstNode: () => j,
	isAstNodeDescription: () => dn,
	isAstNodeWithComment: () => DM,
	isCompositeCstNode: () => mn,
	isIMultiModeLexerDefinition: () => eN,
	isJSDoc: () => rN,
	isLeafCstNode: () => hn,
	isLinkingError: () => fn,
	isMultiReference: () => un,
...
var Jj = class {
	...
	update(t, n) {
		for (let n of t) if (e.isIncremental(n)) {
			let e = eM(n.range), t = this.offsetAt(e.start), r = this.offsetAt(e.end);
			this._content = this._content.substring(0, t) + n.text + this._content.substring(r, this._content.length);
			let i = Math.max(e.start.line, 0), a = Math.max(e.end.line, 0), o = this._lineOffsets, s = Qj(n.text, !1, t);
	...
	getLineOffsets() {
		return this._lineOffsets === void 0 && (this._lineOffsets = Qj(this._content, !0)), this._lineOffsets;
	}
	positionAt(e) {
		e = Math.max(Math.min(e, this._content.length), 0);
		let t = this.getLineOffsets(), n = 0, r = t.length;
	...
	ensureBeforeEOL(e, t) {
		for (; e > t && $j(this._content.charCodeAt(e - 1));) e--;
		return e;
	}
	get lineCount() {
		return this.getLineOffsets().length;
...
function Qj(e, t, n = 0) {
	...
	for (let t = 0; t < e.length; t++) {
		...
		$j(i) && (i === 13 && t + 1 < e.length && e.charCodeAt(t + 1) === 10 && t++, r.push(n + t + 1));
	}
	return r;
}
o(Qj, "computeLineOffsets");
function $j(e) {
	return e === 13 || e === 10;
}
o($j, "isEOL");
...
var { URI: rM, Utils: iM } = nM, aM;
(function(e) {
	e.basename = iM.basename, e.dirname = iM.dirname, e.extname = iM.extname, e.joinPath = iM.joinPath, e.resolvePath = iM.resolvePath;
	...
	function r(e, n) {
		let r = typeof e == "string" ? rM.parse(e).path : e.path, i = typeof n == "string" ? rM.parse(n).path : n.path, a = r.split("/").filter((e) => e.length > 0), o = i.split("/").filter((e) => e.length > 0);
		if (t) {
			let e = /^[A-Z]:$/;
	...
	function i(e) {
		return rM.parse(e.toString()).toString();
	}
...
var oM = class {
	...
	findNode(e) {
		...
		if (n) return {
			name: n.name,
			uri: aM.joinPath(rM.parse(t), n.name).toString(),
			element: n.element
		};
	}
	findChildren(e) {
		...
		return n ? Array.from(n.children.values()).map((e) => ({
			name: e.name,
			uri: aM.joinPath(rM.parse(t), e.name).toString(),
			element: e.element
		})) : [];
	}
	all() {
	...
	findAll(e) {
		let t = this.getNode(aM.normalize(e), !1);
...
var sM = class {
	...
	fromTextDocument(e, t, n) {
		return t ??= rM.parse(e.uri), Z.CancellationToken.is(n) ? this.createAsync(t, e, n) : this.create(t, e, n);
	}
	fromString(e, t, n) {
	...
	createTextDocumentGetter(e, t) {
		...
		return () => r ??= Xj.create(e.toString(), n.getServices(e).LanguageMetaData.languageId, 0, t ?? "");
	}
}, cM = class {
	static {
	...
	constructor(e) {
		this.documentTrie = new oM(), this.services = e, this.langiumDocumentFactory = e.workspace.LangiumDocumentFactory, this.documentBuilder = () => e.workspace.DocumentBuilder;
	}
	get all() {
...
}, lM = Symbol("RefResolving"), uM = class {
	static {
	...
	async link(e, t = Z.CancellationToken.None) {
		if (this.profiler?.isActive("linking")) {
			...
			n.start();
			try {
				for (let r of Nn(e.parseResult.value)) await qj(t), Fn(r).forEach((t) => {
		...
		} else for (let n of Nn(e.parseResult.value)) await qj(t), Fn(n).forEach((t) => this.doLink(t, e));
	}
	doLink(e, t) {
		let n = e.reference;
	...
	buildReference(e, t, n, r) {
		let i = this, a = {
			...
			get ref() {
				...
				} else this._ref === lM && i.throwCyclicReferenceError(e, t, r);
	...
	buildMultiReference(e, t, n, r) {
		let i = this, a = {
			...
			get items() {
				...
				} else this._items === lM && i.throwCyclicReferenceError(e, t, r);
...
var fM = class {
	...
	findReferences(e, t) {
		...
		return t.documentUri && (r = r.filter((e) => aM.equals(e.sourceUri, t.documentUri))), n.push(...r), M(n);
	}
	getSelfReferences(e) {
	...
	async collectExportedSymbolsForNode(e, t, n = jn, r = Z.CancellationToken.None) {
		...
		for (let a of n(e)) await qj(r), this.addExportedSymbol(a, i, t);
		return i;
	}
	...
	async collectLocalSymbols(e, t = Z.CancellationToken.None) {
		let n = e.parseResult.value, r = new mM();
		for (let i of Mn(n)) await qj(t), this.addLocalSymbol(i, e, r);
		return r;
	}
	...
	constructor(e, t, n) {
		this.elements = new mM(), this.caseInsensitive = n?.caseInsensitive ?? !1, this.concatOuterScope = n?.concatOuterScope ?? !0;
		for (let t of e) {
			let e = this.caseInsensitive ? t.name.toLowerCase() : t.name;
...
var kM = class {
	...
	linkNode(e, t, n, r, i, a) {
		for (let [r, i] of Object.entries(e)) if (Array.isArray(i)) for (let a = 0; a < i.length; a++) {
			let o = i[a];
			OM(o) ? i[a] = this.reviveReference(e, r, t, o, n) : j(o) && this.linkNode(o, t, n, e, r, a);
		}
		else OM(i) ? e[r] = this.reviveReference(e, r, t, i, n) : j(i) && this.linkNode(i, t, n, e, r);
		let o = e;
	...
	getRefNode(e, t, n) {
		try {
			...
			if (r < 0) {
				let e = n ? n(t) : rM.parse(t), r = this.langiumDocuments.getDocument(e);
				return r ? r.parseResult.value : "Could not find document for URI: " + t;
			}
			let i = n ? n(t.substring(0, r)) : rM.parse(t.substring(0, r)), a = this.langiumDocuments.getDocument(i);
	...
	getServices(e) {
		...
		let n = aM.extname(e), r = aM.basename(e), i = this.fileNameMap.get(r) ?? this.fileExtensionMap.get(n);
...
var NM = class {
	...
	constructor(e) {
		this.entries = new mM(), this.knownCategories = new Set(MM.defaults), this.entriesBefore = [], this.entriesAfter = [], this.reflection = e.shared.AstReflection;
	}
	...
	async validateAstBefore(e, t, n, r = Z.CancellationToken.None) {
		...
		for (let a of i) await qj(r), await a(e, n, t.categories ?? [], r);
	}
...
o(LM, "toDiagnosticSeverity");
function RM(e) {
	switch (e) {
		case "error": return jM(zM.LexingError);
		case "warning": return jM(zM.LexingWarning);
		case "info": return jM(zM.LexingInfo);
		case "hint": return jM(zM.LexingHint);
		default: throw Error("Invalid diagnostic severity: " + e);
	}
}
o(RM, "toDiagnosticData");
var zM;
(function(e) {
...
var BM = class {
	...
	async createDescriptions(e, t = Z.CancellationToken.None) {
		...
		for (let e of Nn(r)) await qj(t), Fn(e).forEach((e) => {
	...
	createInfoDescriptions(e) {
		...
		for (let e of n) a.push({
			...
			targetPath: e.path,
			segment: o,
			local: aM.equals(e.documentUri, r)
		});
		return a;
	}
}, HM = class {
...
var WM = class {
	...
	constructor(e) {
		this._ready = new Jj(), this.onConfigurationSectionUpdateEmitter = new UM.Emitter(), this.settings = {}, this.workspaceConfig = !1, this.serviceRegistry = e.ServiceRegistry;
	}
	get ready() {
...
var qM = class {
	...
	async update(e, t, n = Z.CancellationToken.None) {
		...
		this.langiumDocuments.all.filter((e) => !a.has(e.uri.toString()) && this.shouldRelink(e, a)).forEach((e) => this.resetToState(e, Q.ComputedScopes)), await this.emitUpdate(i, r), await qj(n);
	...
	onUpdate(e) {
		return this.updateListeners.push(e), KM.create(() => {
	...
	async runCancelable(e, t, n, r) {
		for (let i of e) i.state < t && (await qj(n), await r(i), i.state = t, await this.notifyDocumentPhase(i, t, n));
		let i = e.filter((e) => e.state === t);
		await this.notifyBuildPhase(i, t, n), this.currentState = t;
	}
	onBuildPhase(e, t) {
		return this.buildPhaseListeners.add(e, t), KM.create(() => {
			this.buildPhaseListeners.delete(e, t);
		});
	}
	onDocumentPhase(e, t) {
		return this.documentPhaseListeners.add(e, t), KM.create(() => {
	...
	awaitDocumentState(e, t, n) {
		...
		return r ? r.state >= e ? Promise.resolve(t) : n.isCancellationRequested ? Promise.reject(Gj) : this.currentState >= e && e > r.state ? Promise.reject(new GM.ResponseError(GM.LSPErrorCodes.RequestFailed, `Document state of ${t.toString()} is ${Q[r.state]}, requiring ${Q[e]}, but workspace state is already ${Q[this.currentState]}. Returning undefined.`)) : new Promise((r, i) => {
			let a = this.onDocumentPhase(e, (e) => {
				aM.equals(e.uri, t) && (a.dispose(), o.dispose(), r(e.uri));
			}), o = n.onCancellationRequested(() => {
				a.dispose(), o.dispose(), i(Gj);
			});
		}) : Promise.reject(new GM.ResponseError(GM.LSPErrorCodes.ServerCancelled, `No document found for URI: ${t.toString()}`));
	}
	...
	async notifyBuildPhase(e, t, n) {
		...
		for (let t of r) await qj(n), await t(e, n);
	}
	shouldLink(e) {
	...
	constructor(e) {
		this.symbolIndex = /* @__PURE__ */ new Map(), this.symbolByTypeIndex = new CM(), this.referenceIndex = /* @__PURE__ */ new Map(), this.documents = e.workspace.LangiumDocuments, this.serviceRegistry = e.ServiceRegistry, this.astReflection = e.AstReflection;
	}
	findAllReferences(e, t) {
		let n = On(e).uri, r = [];
		return this.referenceIndex.forEach((e) => {
			e.forEach((e) => {
				aM.equals(e.targetUri, n) && e.targetPath === t && r.push(e);
			});
		}), M(r);
	}
	allElements(e, t) {
	...
	constructor(e) {
		this.initialBuildOptions = {}, this._ready = new Jj(), this.serviceRegistry = e.ServiceRegistry, this.langiumDocuments = e.workspace.LangiumDocuments, this.documentBuilder = e.workspace.DocumentBuilder, this.fileSystemProvider = e.workspace.FileSystemProvider, this.mutex = e.workspace.WorkspaceLock;
	}
	get ready() {
		return this._ready.promise;
	}
	...
	async initializeWorkspace(e, t = Z.CancellationToken.None) {
		...
		await qj(t), await this.documentBuilder.build(n, this.initialBuildOptions, t);
	}
	...
	constructor(e) {
		...
		let n = tN(t) ? Object.values(t) : t, r = e.LanguageMetaData.mode === "production";
	...
	toTokenTypeDictionary(e) {
		if (tN(e)) return e;
		let t = eN(e) ? Object.values(e.modes).flat() : e, n = {};
...
o($M, "isTokenTypeArray");
function eN(e) {
	return e && "modes" in e && "defaultMode" in e;
}
o(eN, "isIMultiModeLexerDefinition");
function tN(e) {
	return !$M(e) && !eN(e);
}
o(tN, "isTokenTypeDictionary"), gt();
function nN(e, t, n) {
	let r, i;
...
o(iN, "getLines");
var aN = /\s*(@([\p{L}][\p{L}\p{N}]*)?)/uy, oN = /\{(@[\p{L}][\p{L}\p{N}]*)(\s*)([^\r\n}]+)?\}/gu;
function sN(e) {
	...
	for (let i = 0; i < e.lines.length; i++) {
		...
		if (s = s.substring(0, fN(s)), dN(s, c) >= s.length) {
			if (t.length > 0) {
				let e = y.create(n, r);
				t.push({
					type: "break",
			...
			if (c < s.length) {
				let e = s.substring(c), i = Array.from(e.matchAll(oN));
				t.push(...cN(i, e, n, r + c));
			}
		}
		n++, r = 0;
...
o(cN, "buildInlineTokens");
var lN = /\S/, uN = /\s*$/;
function dN(e, t) {
	let n = e.substring(t).match(lN);
...
function pN(e) {
	...
	if (e.tokens.length === 0) return new SN([], b.create(t, t));
	let n = [];
	for (; e.index < e.tokens.length;) {
		let t = mN(e, n[n.length - 1]);
		t && n.push(t);
	}
	let r = n[0]?.range.start ?? t, i = n[n.length - 1]?.range.end ?? t;
	return new SN(n, b.create(r, i));
}
o(pN, "parseJSDocComment");
function mN(e, t) {
	let n = e.tokens[e.index];
	if (n.type === "tag") return vN(e, !1);
	if (n.type === "text" || n.type === "inline-tag") return gN(e);
	hN(n, t), e.index++;
}
o(mN, "parseJSDocElement");
function hN(e, t) {
	if (t) {
		let n = new DN("", e.range);
		"inlines" in t ? t.inlines.push(n) : t.content.inlines.push(n);
	}
}
o(hN, "appendEmptyLine");
function gN(e) {
	let t = e.tokens[e.index], n = t, r = t, i = [];
	for (; t && t.type !== "break" && t.type !== "tag";) i.push(_N(e)), r = t, t = e.tokens[e.index];
	return new EN(i, b.create(n.range.start, r.range.end));
}
o(gN, "parseJSDocText");
function _N(e) {
	return e.tokens[e.index].type === "inline-tag" ? vN(e, !0) : yN(e);
}
o(_N, "parseJSDocInline");
function vN(e, t) {
	let n = e.tokens[e.index++], r = n.content.substring(1);
	if (e.tokens[e.index]?.type === "text") if (t) {
		let i = yN(e);
		return new CN(r, new EN([i], i.range), t, b.create(n.range.start, i.range.end));
	} else {
		let i = gN(e);
		return new CN(r, i, t, b.create(n.range.start, i.range.end));
	}
	else {
		let e = n.range;
		return new CN(r, new EN([], e), t, e);
	}
}
o(vN, "parseJSDocTag");
function yN(e) {
...
function wN(e, t, n) {
	if (e === "linkplain" || e === "linkcode" || e === "link") {
		...
		return (e === "linkcode" || e === "link" && n.link === "code") && (i = `\`${i}\``), n.renderLink?.(t, i) ?? TN(t, i);
	}
}
o(wN, "renderInlineTag");
function TN(e, t) {
	try {
		return rM.parse(e, !0), `[${t}](${e})`;
	} catch {
		return e;
	}
}
o(TN, "renderLinkDefault");
var EN = class {
	static {
...
var kN = class {
	...
	getDocumentation(e) {
		...
		if (t && rN(t)) return nN(t).toMarkdown({
	...
	getComment(e) {
		return DM(e) ? e.$comment : qi(e.$cstNode, this.grammarConfig().multilineCommentRules)?.text;
	}
}, jN = class {
	static {
	...
	async parse(e, t) {
		let n = await this.acquireParserWorker(t), r = new Jj(), i, a = t.onCancellationRequested(() => {
			i = setTimeout(() => {
	...
	constructor(e, t, n, r) {
		this.onReadyEmitter = new UM.Emitter(), this.deferred = new Jj(), this._ready = !0, this._parsing = !1, this.sendMessage = e, this._terminate = r, t((e) => {
			let t = e;
	...
	parse(e) {
		...
		return this._parsing = !0, this.deferred = new Jj(), this.sendMessage(e), this.deferred.promise;
	}
}, PN = class {
	static {
	...
	constructor(e) {
		this.grammarElementIdMap = new hM(), this.tokenTypeIdMap = new hM(), this.grammar = e.Grammar, this.lexer = e.parser.Lexer, this.linker = e.references.Linker;
	}
	dehydrate(e) {
		return {
...
function IN(e) {
	return {
		documentation: {
			CommentProvider: /* @__PURE__ */ o((e) => new AN(e), "CommentProvider"),
			DocumentationProvider: /* @__PURE__ */ o((e) => new kN(e), "DocumentationProvider")
		},
		parser: {
			AsyncParser: /* @__PURE__ */ o((e) => new jN(e), "AsyncParser"),
			...
			Lexer: /* @__PURE__ */ o((e) => new QM(e), "Lexer"),
			ParserErrorMessageProvider: /* @__PURE__ */ o(() => new dj(), "ParserErrorMessageProvider"),
			LexerErrorMessageProvider: /* @__PURE__ */ o(() => new XM(), "LexerErrorMessageProvider")
		},
		workspace: {
			AstNodeLocator: /* @__PURE__ */ o(() => new HM(), "AstNodeLocator"),
			AstNodeDescriptionProvider: /* @__PURE__ */ o((e) => new BM(e), "AstNodeDescriptionProvider"),
			ReferenceDescriptionProvider: /* @__PURE__ */ o((e) => new VM(e), "ReferenceDescriptionProvider")
		},
		references: {
			Linker: /* @__PURE__ */ o((e) => new uM(e), "Linker"),
			NameProvider: /* @__PURE__ */ o(() => new fM(), "NameProvider"),
			ScopeProvider: /* @__PURE__ */ o((e) => new EM(e), "ScopeProvider"),
			ScopeComputation: /* @__PURE__ */ o((e) => new gM(e), "ScopeComputation"),
			References: /* @__PURE__ */ o((e) => new pM(e), "References")
		},
		serializer: {
			Hydrator: /* @__PURE__ */ o((e) => new FN(e), "Hydrator"),
			JsonSerializer: /* @__PURE__ */ o((e) => new kM(e), "JsonSerializer")
		},
		validation: {
			DocumentValidator: /* @__PURE__ */ o((e) => new FM(e), "DocumentValidator"),
			ValidationRegistry: /* @__PURE__ */ o((e) => new NM(e), "ValidationRegistry")
		},
		shared: /* @__PURE__ */ o(() => e.shared, "shared")
	};
}
o(IN, "createDefaultCoreModule");
function LN(e) {
	return {
		ServiceRegistry: /* @__PURE__ */ o((e) => new AM(e), "ServiceRegistry"),
		workspace: {
			LangiumDocuments: /* @__PURE__ */ o((e) => new cM(e), "LangiumDocuments"),
			LangiumDocumentFactory: /* @__PURE__ */ o((e) => new sM(e), "LangiumDocumentFactory"),
			DocumentBuilder: /* @__PURE__ */ o((e) => new qM(e), "DocumentBuilder"),
			IndexManager: /* @__PURE__ */ o((e) => new JM(e), "IndexManager"),
			WorkspaceManager: /* @__PURE__ */ o((e) => new YM(e), "WorkspaceManager"),
			FileSystemProvider: /* @__PURE__ */ o((t) => e.fileSystemProvider(t), "FileSystemProvider"),
			WorkspaceLock: /* @__PURE__ */ o(() => new PN(), "WorkspaceLock"),
			ConfigurationProvider: /* @__PURE__ */ o((e) => new WM(e), "ConfigurationProvider")
		},
		profilers: {}
	};
}
o(LN, "createDefaultSharedCoreModule");
var RN;
(function(e) {
...
var qN = class extends Lj {
	...
	buildTokens(e, t) {
		...
		if (!$M(n)) throw Error("Invalid tokens built by default builder");
...
function eP() {
	let e = $(LN(ZN), $N), t = $(IN({ shared: e }), QN);
...
function tP(e) {
	...
	return t.shared.workspace.LangiumDocumentFactory.fromModel(n, rM.parse(`memory:/${n.name ?? "grammar"}.langium`)), n;
}
...
var nP = class {
	...
	constructor(e) {
		this.activeCategories = /* @__PURE__ */ new Set(), this.allCategories = /* @__PURE__ */ new Set([
			...
			"parsing",
			"linking"
		]), this.activeCategories = e ?? new Set(this.allCategories), this.records = new mM();
	}
	isActive(e) {
	...
	constructor(e, t) {
		this.stack = [], this.entries = new mM(), this.addRecord = e, this.identifier = t;
	}
	start() {
...
var TI = class extends wI {
	...
	TokenBuilder: /* @__PURE__ */ o(() => new TI(), "TokenBuilder"),
	ValueConverter: /* @__PURE__ */ o(() => new EI(), "ValueConverter")
} };
function OI(e = ZN) {
	let t = $(LN(e), uI), n = $(IN({ shared: t }), dI, DI);
	return t.ServiceRegistry.register(n), {
		shared: t,
		Architecture: n
	};
}
o(OI, "createArchitectureServices");
//#endregion
...
}, AI = /* @__PURE__ */ new Set(["cmd", "command"]), jI = /* @__PURE__ */ new Set(["evt", "event"]), MI = /* @__PURE__ */ new Set(["rmo", "readmodel"]), NI = /* @__PURE__ */ new Set(["pcr", "processor"]), PI = /* @__PURE__ */ new Set(["ui"]);
function FI(e) {
...
o(FI, "registerValidationChecks");
var II = class {
	static {
		o(this, "EventModelingValidator");
	}
	checkSourceFrameTypes(e, t) {
		e.sourceFrames.length !== 0 && (AI.has(e.modelEntityType) ? this.validateSources(e, /* @__PURE__ */ new Set([...PI, ...NI]), "command", "ui or processor", t) : jI.has(e.modelEntityType) ? this.validateSources(e, AI, "event", "command", t) : MI.has(e.modelEntityType) ? this.validateSources(e, jI, "read model", "event", t) : NI.has(e.modelEntityType) ? this.validateSources(e, MI, "processor", "read model", t) : PI.has(e.modelEntityType) && this.validateSources(e, MI, "ui", "read model", t));
	}
	...
	parser: {
		TokenBuilder: /* @__PURE__ */ o(() => new kI(), "TokenBuilder"),
		ValueConverter: /* @__PURE__ */ o(() => new CI(), "ValueConverter")
	},
	validation: { EventModelingValidator: /* @__PURE__ */ o(() => new II(), "EventModelingValidator") }
};
function RI(e = ZN) {
	let t = $(LN(e), uI), n = $(IN({ shared: t }), fI, LI);
	return t.ServiceRegistry.register(n), FI(n), {
		shared: t,
		EventModel: n
	};
}
o(RI, "createEventModelingServices");
//#endregion
...
var zI = class extends wI {
	...
	TokenBuilder: /* @__PURE__ */ o(() => new zI(), "TokenBuilder"),
	ValueConverter: /* @__PURE__ */ o(() => new CI(), "ValueConverter")
} };
function VI(e = ZN) {
	let t = $(LN(e), uI), n = $(IN({ shared: t }), pI, BI);
	return t.ServiceRegistry.register(n), {
		shared: t,
		GitGraph: n
	};
}
o(VI, "createGitGraphServices");
//#endregion
...
var HI = class extends wI {
	...
	TokenBuilder: /* @__PURE__ */ o(() => new HI(), "TokenBuilder"),
	ValueConverter: /* @__PURE__ */ o(() => new CI(), "ValueConverter")
} };
function WI(e = ZN) {
	let t = $(LN(e), uI), n = $(IN({ shared: t }), mI, UI);
	return t.ServiceRegistry.register(n), {
		shared: t,
		Info: n
	};
}
o(WI, "createInfoServices");
//#endregion
...
var GI = class extends wI {
	...
	TokenBuilder: /* @__PURE__ */ o(() => new GI(), "TokenBuilder"),
	ValueConverter: /* @__PURE__ */ o(() => new CI(), "ValueConverter")
} };
function qI(e = ZN) {
	let t = $(LN(e), uI), n = $(IN({ shared: t }), hI, KI);
	return t.ServiceRegistry.register(n), {
		shared: t,
		Packet: n
	};
}
o(qI, "createPacketServices");
//#endregion
...
var JI = class extends wI {
	...
	TokenBuilder: /* @__PURE__ */ o(() => new JI(), "TokenBuilder"),
	ValueConverter: /* @__PURE__ */ o(() => new YI(), "ValueConverter")
} };
function ZI(e = ZN) {
	let t = $(LN(e), uI), n = $(IN({ shared: t }), gI, XI);
	return t.ServiceRegistry.register(n), {
		shared: t,
		Pie: n
	};
}
o(ZI, "createPieServices");
//#endregion
...
var QI = class extends wI {
	...
	TokenBuilder: /* @__PURE__ */ o(() => new QI(), "TokenBuilder"),
	ValueConverter: /* @__PURE__ */ o(() => new CI(), "ValueConverter")
} };
function eL(e = ZN) {
	let t = $(LN(e), uI), n = $(IN({ shared: t }), _I, $I);
	return t.ServiceRegistry.register(n), {
		shared: t,
		Radar: n
	};
}
o(eL, "createRadarServices");
//#endregion
...
var tL = class extends SI {
	...
	TokenBuilder: /* @__PURE__ */ o(() => new nL(), "TokenBuilder"),
	ValueConverter: /* @__PURE__ */ o(() => new tL(), "ValueConverter")
} };
function iL(e = ZN) {
	let t = $(LN(e), uI), n = $(IN({ shared: t }), yI, rL);
	return t.ServiceRegistry.register(n), {
		shared: t,
		TreeView: n
	};
}
o(iL, "createTreeViewServices");
//#endregion
...
}, oL = /classDef\s+([A-Z_a-z]\w+)(?:\s+([^\n\r;]*))?;?/, sL = class extends SI {
	static {
...
var lL = class {
	...
	parser: {
		TokenBuilder: /* @__PURE__ */ o(() => new aL(), "TokenBuilder"),
		ValueConverter: /* @__PURE__ */ o(() => new sL(), "ValueConverter")
	},
	validation: { TreemapValidator: /* @__PURE__ */ o(() => new lL(), "TreemapValidator") }
};
function dL(e = ZN) {
	let t = $(LN(e), uI), n = $(IN({ shared: t }), vI, uL);
	return t.ServiceRegistry.register(n), cL(n), {
		shared: t,
		Treemap: n
	};
}
o(dL, "createTreemapServices");
//#endregion
...
}, pL = { parser: { ValueConverter: /* @__PURE__ */ o(() => new fL(), "ValueConverter") } };
function mL(e = ZN) {
	let t = $(LN(e), uI), n = $(IN({ shared: t }), bI, pL);
	return t.ServiceRegistry.register(n), {
		shared: t,
		Wardley: n
	};
}
o(mL, "createWardleyServices");
//#endregion
//#region node_modules/.pnpm/@mermaid-js+parser@1.1.1/node_modules/@mermaid-js/parser/dist/mermaid-parser.core.mjs
var hL = {}, gL = {
	info: /* @__PURE__ */ o(async () => {
		let { createInfoServices: e } = await import("./info-J43DQDTF-DgF9xHWd.js");
		hL.info = e().Info.parser.LangiumParser;
	}, "info"),
	packet: /* @__PURE__ */ o(async () => {
		let { createPacketServices: e } = await import("./packet-YPE3B663-3piaSvsW.js");
		hL.packet = e().Packet.parser.LangiumParser;
	}, "packet"),
	pie: /* @__PURE__ */ o(async () => {
		let { createPieServices: e } = await import("./pie-LRSECV5Y-_uf9h0Oy.js");
		hL.pie = e().Pie.parser.LangiumParser;
	}, "pie"),
	treeView: /* @__PURE__ */ o(async () => {
		let { createTreeViewServices: e } = await import("./treeView-BLDUP644-B5V3Ajvr.js");
		hL.treeView = e().TreeView.parser.LangiumParser;
	}, "treeView"),
	architecture: /* @__PURE__ */ o(async () => {
		let { createArchitectureServices: e } = await import("./architecture-7EHR7CIX-BQ8_WXSe.js");
		hL.architecture = e().Architecture.parser.LangiumParser;
	}, "architecture"),
	gitGraph: /* @__PURE__ */ o(async () => {
		let { createGitGraphServices: e } = await import("./gitGraph-WXDBUCRP-Dc-9LVi3.js");
		hL.gitGraph = e().GitGraph.parser.LangiumParser;
	}, "gitGraph"),
	eventmodeling: /* @__PURE__ */ o(async () => {
		let { createEventModelingServices: e } = await import("./eventmodeling-FCH6USID-CBqCcg5s.js");
		hL.eventmodeling = e().EventModel.parser.LangiumParser;
	}, "eventmodeling"),
	radar: /* @__PURE__ */ o(async () => {
		let { createRadarServices: e } = await import("./radar-GUYGQ44K-DMi-csVg.js");
		hL.radar = e().Radar.parser.LangiumParser;
	}, "radar"),
	treemap: /* @__PURE__ */ o(async () => {
		let { createTreemapServices: e } = await import("./treemap-LRROVOQU-eTOESlei.js");
		hL.treemap = e().Treemap.parser.LangiumParser;
	}, "treemap"),
	wardley: /* @__PURE__ */ o(async () => {
		let { createWardleyServices: e } = await import("./wardley-L42UT6IY-O-HaEk4v.js");
		hL.wardley = e().Wardley.parser.LangiumParser;
	}, "wardley")
};
async function _L(e, t) {
	...
	hL[e] || await n();
	let r = hL[e].parse(t);
	if (r.lexerErrors.length > 0 || r.parserErrors.length > 0) throw new vL(r);
	return r.value;
}
o(_L, "parse");
...
//#endregion
export { UP as S, VI as _, dL as a, DI as b, $I as c, ZI as d, KI as f, BI as g, WI as h, uL as i, eL as l, UI as m, pL as n, rL as o, qI as p, mL as r, iL as s, _L as t, XI as u, LI as v, OI as x, RI as y };
