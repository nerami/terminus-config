...
import { t } from "./linear-BHg6RSG6.js";
import { n, r } from "./src-BYM73fzN.js";
import { D as i, H as a, K as o, U as s, a as c, c as l, f as u, v as d, w as f, x as p, y as m, z as h } from "./chunk-CSCIHK7Q-AEjI_JHf.js";
...
var g = (function() {
	var e = /* @__PURE__ */ n(function(e, t, n, r) {
		...
		return n;
	}, "o"), t = [1, 3], r = [1, 4], i = [1, 5], a = [1, 6], o = [1, 7], s = [
		1,
		4,
		5,
		10,
	...
	return n($, "Parser"), $.prototype = me, me.Parser = $, new $();
})();
g.parser = g;
var _ = g, v = i(), y = class {
	constructor() {
	...
	setConfig(e) {
		r.trace("setConfig called with: ", e), this.config = {
			...this.config,
			...e
		};
	}
	setThemeConfig(e) {
		r.trace("setThemeConfig called with: ", e), this.themeConfig = {
			...this.themeConfig,
			...e
		};
	}
	...
	getQuadrantPoints(e) {
		let { quadrantSpace: n } = e, { quadrantHeight: r, quadrantLeft: i, quadrantTop: a, quadrantWidth: o } = n, s = t().domain([0, 1]).range([i, o + i]), c = t().domain([0, 1]).range([r + a, a]);
...
var ee = {
	...
	renderer: { draw: /* @__PURE__ */ n((t, i, a, o) => {
		function s(e) {
		...
		n(u, "getTransformation");
		let d = p();
		r.debug("Rendering quadrant chart\n" + t);
		let f = d.securityLevel, m;
		f === "sandbox" && (m = e("#i" + i));
		let h = e(f === "sandbox" ? m.nodes()[0].contentDocument.body : "body").select(`[id="${i}"]`), g = h.append("g").attr("class", "main"), _ = d.quadrantChart?.chartWidth ?? 500, v = d.quadrantChart?.chartHeight ?? 500;
		l(h, v, _, d.quadrantChart?.useMaxWidth ?? !0), h.attr("viewBox", "0 0 " + _ + " " + v), o.db.setHeight(v), o.db.setWidth(_);
