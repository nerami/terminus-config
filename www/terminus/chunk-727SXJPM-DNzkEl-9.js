...
import { $ as r, H as i, K as a, M as o, U as s, a as c, s as l, v as u, w as d, x as f, y as p, z as m } from "./chunk-CSCIHK7Q-AEjI_JHf.js";
import { c as h, g } from "./chunk-5ZQYHXKU--OC8flB4.js";
import { t as _ } from "./chunk-FMBD7UC4-Dag3b6ut.js";
import { t as v } from "./chunk-ND2GUHAM-UviPDEk1.js";
import { t as y } from "./chunk-55IACEB6-DgbZ_hR3.js";
import { t as b } from "./chunk-2J33WTMH-Dok3JTva.js";
import { r as x, t as S } from "./chunk-LZXEDZCA-Cl3f5Z5P.js";
...
var w = C, T = [
	...
	constructor() {
		this.relations = [], this.classes = /* @__PURE__ */ new Map(), this.styleClasses = /* @__PURE__ */ new Map(), this.notes = /* @__PURE__ */ new Map(), this.interfaces = [], this.namespaces = /* @__PURE__ */ new Map(), this.namespaceCounter = 0, this.namespaceStack = [], this.diagramId = "", this.functions = [], this.lineType = {
			...
			let n = v();
			e(t).select("svg").selectAll("g").filter(function() {
				return e(this).attr("title") !== null;
			}).on("mouseover", (t) => {
				let i = e(t.currentTarget), a = i.attr("title");
				if (!a) return;
				let o = t.currentTarget.getBoundingClientRect();
				n.transition().duration(200).style("opacity", ".9"), n.html(r.sanitize(a)).style("left", `${window.scrollX + o.left + o.width / 2}px`).style("top", `${window.scrollY + o.bottom + 4}px`), i.classed("hover", !0);
			}).on("mouseout", (t) => {
