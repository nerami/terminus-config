...
import { t } from "./mermaid-parser.core-C2N6lMD4.js";
import { n, r } from "./src-BYM73fzN.js";
import { H as i, K as a, U as o, Y as s, a as c, b as l, f as u, s as d, v as f, w as p, x as m, y as h } from "./chunk-CSCIHK7Q-AEjI_JHf.js";
import { g, i as _, m as v } from "./chunk-5ZQYHXKU--OC8flB4.js";
import { t as y } from "./chunk-4BX2VUAB-B2huEiFx.js";
import { t as b } from "./chunk-QZHKN3VN-RIDhFUsf.js";
...
var te = /* @__PURE__ */ n(function(e) {
	...
	let o = S();
	n = d.sanitizeText(n, o), t = d.sanitizeText(t, o), a = a?.map((e) => d.sanitizeText(e, o));
	let s = {
	...
	C.records.head = s, r.info("main branch", o.mainBranchName), C.records.commits.has(s.id) && r.warn(`Commit ID ${s.id} already exists`), C.records.commits.set(s.id, s), C.records.branches.set(C.records.currBranch, s.id), r.debug("in pushCommit " + s.id);
	...
	C.records.branches.set(t, C.records.head == null ? null : C.records.head.id), C.records.branchConfig.set(t, {
		name: t,
		order: n
	}), E(t), r.debug("in createBranch");
}, "branch"), oe = /* @__PURE__ */ n((e) => {
	let t = e.branch, n = e.id, i = e.type, a = e.tags, o = S();
	t = d.sanitizeText(t, o), n &&= d.sanitizeText(n, o);
	...
	C.records.head = p, C.records.commits.set(p.id, p), C.records.branches.set(C.records.currBranch, p.id), r.debug(C.records.branches), r.debug("in mergeBranch");
}, "merge"), se = /* @__PURE__ */ n(function(e) {
	let t = e.id, n = e.targetId, i = e.tags, a = e.parent;
	r.debug("Entering cherryPick:", t, n, i);
	let o = S();
	if (t = d.sanitizeText(t, o), n = d.sanitizeText(n, o), i = i?.map((e) => d.sanitizeText(e, o)), a = d.sanitizeText(a, o), !t || !C.records.commits.has(t)) {
	...
	if (!n || !C.records.commits.has(n)) {
		...
		C.records.head = l, C.records.commits.set(l.id, l), C.records.branches.set(C.records.currBranch, l.id), r.debug(C.records.branches), r.debug("in cherryPick");
	}
...
var ce = /* @__PURE__ */ n(function() {
...
}, "populate"), me = /* @__PURE__ */ n((e, t) => {
	let i = {
		Commit: /* @__PURE__ */ n((e) => t.commit(he(e)), "Commit"),
		Branch: /* @__PURE__ */ n((e) => t.branch(ge(e)), "Branch"),
		Merge: /* @__PURE__ */ n((e) => t.merge(_e(e)), "Merge"),
		Checkout: /* @__PURE__ */ n((e) => t.checkout(ve(e)), "Checkout"),
		CherryPicking: /* @__PURE__ */ n((e) => t.cherryPick(ye(e)), "CherryPicking")
	}[e.$type];
	...
	parent: e.parent
}), "parseCherryPicking"), be = { parse: /* @__PURE__ */ n(async (e) => {
	let n = await t("gitGraph", e);
	r.debug(n), pe(n, A);
...
}, "setBranchPosition"), Be = { draw: /* @__PURE__ */ n(function(t, n, i, a) {
	Se(), r.debug("in gitgraph renderer", t + "\n", "id:", n, i);
	let o = a.db;
	if (!o.getConfig) {
	...
	K = o.getDirection();
	let d = e(`[id="${n}"]`), { look: f, theme: p, themeVariables: h } = m(), { useGradient: _, gradientStart: v, gradientStop: y, filterColor: b } = h;
	if (_) {
