...
import { n as t, r as n, t as r } from "./src-nrT8XS4T.js";
import { J as i, a, b as o, et as s, o as c, rt as l, tt as u, x as d } from "./chunk-CSCIHK7Q-B8VwERSd.js";
import { t as f } from "./arc-sowdMk1h.js";
import { p } from "./chunk-5ZQYHXKU-C-8o68S6.js";
import { t as m } from "./chunk-WU5MYG2G-DhQZkdcJ.js";
...
function H(t, n) {
	t.each(function() {
		var t = e(this), r = t.text().split(/(\s+|<br>)/).reverse(), i, a = [], o = 1.1, s = t.attr("y"), c = parseFloat(t.attr("dy")), l = t.text(null).append("tspan").attr("x", 0).attr("y", s).attr("dy", c + "em");
		for (let e = 0; e < r.length; e++) i = r[r.length - 1 - e], a.push(i), l.text(a.join(" ").trim()), (l.node().getComputedTextLength() > n || i === "<br>") && (a.pop(), l.text(a.join(" ").trim()), a = i === "<br>" ? [""] : [i], l = t.append("tspan").attr("x", 0).attr("y", s).attr("dy", o + "em").text(i));
	});
}
t(H, "wrap");
var ce = /* @__PURE__ */ t(function(t, n, r, i, a, o = !1) {
	let { theme: s, look: c } = i, l = s?.includes("redux"), u = r % (i?.themeVariables?.THEME_COLOR_LIMIT ?? 12) - 1, d = t.append("g");
	n.section = u, d.attr("class", (n.class ? n.class + " " : "") + "timeline-node " + ("section-" + u));
	let f = d.append("g"), p = d.append("g"), m = p.append("text").text(n.descr).attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle").call(H, n.width).node().getBBox(), h = i.fontSize?.replace ? i.fontSize.replace("px", "") : i.fontSize;
	if (n.height = m.height + h * 1.1 * .5 + n.padding, n.height = Math.max(n.height, n.maxHeight), n.width += 2 * n.padding, p.attr("transform", "translate(" + n.width / 2 + ", " + n.padding / 2 + ")"), l && p.attr("transform", `translate(${n.width / 2}, ${o ? n.padding / 2 + 3 : n.padding})`), ue(f, n, u, a, i), c === "neo" && (d.attr("data-look", "neo"), l)) {
		let n = s.includes("dark"), r = e(t.node()?.ownerSVGElement ?? t.node()), i = r.attr("id") ?? "", a = i ? `${i}-drop-shadow` : "drop-shadow";
		if (r.select(`#${a}`).empty()) {
			let e = r.select("defs");
			(e.empty() ? r.append("defs") : e).append("filter").attr("id", a).attr("height", "130%").attr("width", "130%").append("feDropShadow").attr("dx", "4").attr("dy", "4").attr("stdDeviation", 0).attr("flood-opacity", n ? "0.2" : "0.06").attr("flood-color", n ? "#FFFFFF" : "#000000");
		}
	}
	return n;
...
}, de = /* @__PURE__ */ t(function(t, r, a, o) {
	...
	g === "sandbox" && (_ = e("#i" + r));
	let v = e(g === "sandbox" ? _.nodes()[0].contentDocument.body : "body").select("#" + r);
	v.append("g");
	let y = o.db.getTasks(), b = o.db.getCommonDb().getDiagramTitle();
	n.debug("task", y), U.initGraphics(v, r);
	...
	n.debug("maxSectionHeight before draw", S), n.debug("maxTaskHeight before draw", C), x && x.length > 0 ? x.forEach((e) => {
		let t = y.filter((t) => t.section === e), i = {
			number: O,
			descr: e,
			section: O,
...
}, "draw"), W = /* @__PURE__ */ t(function(e, t, r, i, a, o, s, c, l, u, d, f) {
	for (let c of t) {
		let t = {
			descr: c.task,
			section: r,
		...
		if (n.debug("taskHeight after draw", p), u.attr("transform", `translate(${i}, ${a})`), o = Math.max(o, p), c.events) {
			...
			a += 100, n += fe(e, c.events, r, i, a, s, f), a -= 100, t.append("line").attr("x1", i + 190 / 2).attr("y1", a + o).attr("x2", i + 190 / 2).attr("y2", a + o + 100 + l + 100).attr("stroke-width", 2).attr("stroke", "black").attr("marker-end", `url(#${f}-arrowhead)`).attr("stroke-dasharray", "5,5");
		}
		i += 200, d && !s.timeline?.disableMulticolor && r++;
	}
	a -= 10;
}, "drawTasks"), fe = /* @__PURE__ */ t(function(e, t, r, i, a, o, s) {
	let c = 0, l = a;
	a += 100;
	for (let l of t) {
		let t = {
	...
	draw: de
}, G = 200, K = 5, me = G + K * 2, q = G + 100, he = q + K * 2, J = 10, ge = 0, Y = 20, X = 20, Z = 30, Q = 50, _e = /* @__PURE__ */ t(function(e, t, r, a) {
...
}, "draw"), $ = /* @__PURE__ */ t(function(e, t, r, i, a, o, s, c, l) {
	for (let u of t) {
		let t = {
			descr: u.task,
			section: r,
...
}, "drawTasks"), ve = /* @__PURE__ */ t(function(e, t, r, i, a, o, s) {
	let c = o;
	for (let o of t) {
		let t = {
			descr: o,
