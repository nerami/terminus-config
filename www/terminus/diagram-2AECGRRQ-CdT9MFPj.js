...
import { D as r, H as i, K as a, U as o, a as s, b as c, c as l, f as u, v as d, w as f, y as p } from "./chunk-CSCIHK7Q-AEjI_JHf.js";
import { i as m } from "./chunk-5ZQYHXKU--OC8flB4.js";
import { t as h } from "./chunk-WU5MYG2G-D_JlF4fa.js";
import { t as g } from "./chunk-4BX2VUAB-B2huEiFx.js";
...
var _ = {
	...
	curves: [],
	options: _
}, y = structuredClone(v), b = u.radar, x = /* @__PURE__ */ t(() => m({
	...b,
	...c().radar
}), "getConfig"), S = /* @__PURE__ */ t(() => y.axes, "getAxes"), C = /* @__PURE__ */ t(() => y.curves, "getCurves"), w = /* @__PURE__ */ t(() => y.options, "getOptions"), T = /* @__PURE__ */ t((e) => {
	y.axes = e.map((e) => ({
		name: e.name,
		label: e.label ?? e.name
	}));
}, "setAxes"), E = /* @__PURE__ */ t((e) => {
	y.curves = e.map((e) => ({
		name: e.name,
		label: e.label ?? e.name,
		entries: D(e.entries)
	}));
}, "setCurves"), D = /* @__PURE__ */ t((e) => {
...
}, "populate"), A = { parse: /* @__PURE__ */ t(async (t) => {
	let r = await e("radar", t);
	n.debug(r), k(r);
}, "parse") }, j = /* @__PURE__ */ t((e, t, n, r) => {
...
}, "drawFrame"), N = /* @__PURE__ */ t((e, t, n, r, i) => {
...
}, "drawGraticule"), P = /* @__PURE__ */ t((e, t, n, r) => {
	let i = t.length;
	for (let a = 0; a < i; a++) {
