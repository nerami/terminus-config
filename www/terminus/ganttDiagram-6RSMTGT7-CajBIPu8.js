...
import { c as n, d as r, f as i, g as a, h as o, l as s, m as c, w as l } from "./src-4Rgn0kM0.js";
import { a as u, i as d, n as f, r as p, t as m } from "./linear-BHg6RSG6.js";
import { a as h, n as g, r as _ } from "./src-nrT8XS4T.js";
import { H as v, K as y, U as b, a as x, c as S, s as C, v as w, w as T, x as E, y as D } from "./chunk-CSCIHK7Q-B8VwERSd.js";
import { t as O } from "./init-Bwwdo3M6.js";
import { t as k } from "./dist-zbWSleV5.js";
import { g as ee } from "./chunk-5ZQYHXKU-C-8o68S6.js";
...
function le(e) {
	...
	e instanceof i || (e = c(e));
	var t = me(e.r), n = me(e.g), r = me(e.b), a = de((.2225045 * t + .7168786 * n + .0606169 * r) / ie), o, s;
	return t === n && n === r ? o = s = a : (o = de((.4360747 * t + .3850649 * n + .1430804 * r) / re), s = de((.0139322 * t + .0971045 * n + .7141733 * r) / ae)), new M(116 * a - 16, 500 * (o - a), 200 * (a - s), e.opacity);
}
function ue(e, t, n, r) {
...
o(M, ue, a(r, {
	brighter(e) {
		return new M(this.l + ne * (e ?? 1), this.a, this.b, this.opacity);
	},
	darker(e) {
		return new M(this.l - ne * (e ?? 1), this.a, this.b, this.opacity);
	},
	rgb() {
		...
		return t = re * fe(t), e = ie * fe(e), n = ae * fe(n), new i(pe(3.1338561 * t - 1.6168667 * e - .4906146 * n), pe(-.9787684 * t + 1.9161415 * e + .033454 * n), pe(.0719453 * t - .2289914 * e + 1.4052427 * n), this.opacity);
	}
}));
function de(e) {
	return e > ce ? e ** (1 / 3) : e / se + oe;
}
function fe(e) {
	return e > j ? e * e * e : se * (e - oe);
}
function pe(e) {
...
function he(e) {
	...
	if (e instanceof M || (e = le(e)), e.a === 0 && e.b === 0) return new N(NaN, 0 < e.l && e.l < 100 ? 0 : NaN, e.l, e.opacity);
...
o(N, ge, a(r, {
	brighter(e) {
		return new N(this.h, this.c, this.l + ne * (e ?? 1), this.opacity);
	},
	darker(e) {
		return new N(this.h, this.c, this.l - ne * (e ?? 1), this.opacity);
	},
...
function ve(e) {
	return function(t, n) {
		var r = e((t = ge(t)).h, (n = ge(n)).h), i = s(t.c, n.c), a = s(t.l, n.l), o = s(t.opacity, n.opacity);
		return function(e) {
...
var Ce = 1, we = 2, Te = 3, Ee = 4, De = 1e-6;
function Oe(e) {
...
function Ne(e, t) {
	var n = [], r = null, i = null, a = 6, o = 6, s = 3, c = typeof window < "u" && window.devicePixelRatio > 1 ? 0 : .5, l = e === Ce || e === Ee ? -1 : 1, u = e === Ee || e === we ? "x" : "y", d = e === Ce || e === Te ? Oe : ke;
	function f(f) {
		var p = r ?? (t.ticks ? t.ticks.apply(t, n) : t.domain()), m = i ?? (t.tickFormat ? t.tickFormat.apply(t, n) : Se), h = Math.max(a, 0) + s, g = t.range(), _ = +g[0] + c, v = +g[g.length - 1] + c, y = (t.bandwidth ? je : Ae)(t.copy(), c), b = f.selection ? f.selection() : f, x = b.selectAll(".domain").data([null]), S = b.selectAll(".tick").data(p, t).order(), C = S.exit(), w = S.enter().append("g").attr("class", "tick"), T = S.select("line"), E = S.select("text");
		x = x.merge(x.enter().insert("path", ".tick").attr("class", "domain").attr("stroke", "currentColor")), S = S.merge(w), T = T.merge(w.append("line").attr("stroke", "currentColor").attr(u + "2", l * a)), E = E.merge(w.append("text").attr("fill", "currentColor").attr(u, l * h).attr("dy", e === Ce ? "0em" : e === Te ? "0.71em" : "0.32em")), f !== b && (x = x.transition(f), S = S.transition(f), T = T.transition(f), E = E.transition(f), C = C.transition(f).attr("opacity", De).attr("transform", function(e) {
			return isFinite(e = y(e)) ? d(e + c) : this.getAttribute("transform");
		}), w.attr("opacity", De).attr("transform", function(e) {
			var t = this.parentNode.__axis;
			return d((t && isFinite(t = t(e)) ? t : y(e)) + c);
		})), C.remove(), x.attr("d", e === Ee || e === we ? o ? "M" + l * o + "," + _ + "H" + c + "V" + v + "H" + l * o : "M" + c + "," + _ + "V" + v : o ? "M" + _ + "," + l * o + "V" + c + "H" + v + "V" + l * o : "M" + _ + "," + c + "H" + v), S.attr("opacity", 1).attr("transform", function(e) {
			return d(y(e) + c);
		}), T.attr(u + "2", l * a), E.attr(u, l * h).text(m), b.filter(Me).attr("fill", "none").attr("font-size", 10).attr("font-family", "sans-serif").attr("text-anchor", e === we ? "start" : e === Ee ? "end" : "middle"), b.each(function() {
			this.__axis = y;
		});
	}
...
K.every = (e) => !isFinite(e = Math.floor(e)) || !(e > 0) ? null : P((t) => {
...
function zn(e, t, n, r, i, a, o, s, c, l) {
	var u = f(), d = u.invert, m = u.domain, h = l(".%L"), g = l(":%S"), _ = l("%I:%M"), v = l("%I %p"), y = l("%a %d"), b = l("%b %d"), x = l("%B"), S = l("%Y");
	function C(e) {
		return (c(e) < e ? h : s(e) < e ? g : o(e) < e ? _ : a(e) < e ? v : r(e) < e ? i(e) < e ? y : b : n(e) < e ? x : S)(e);
	}
	return u.invert = function(e) {
		return new Date(d(e));
	}, u.domain = function(e) {
		return arguments.length ? m(Array.from(e, Rn)) : m().map(Ln);
	}, u.ticks = function(t) {
		var n = m();
		...
		var n = m();
		return (!e || typeof e.range != "function") && (e = t(n[0], n[n.length - 1], e ?? 10)), e ? m(Ie(n, e)) : u;
	}, u.copy = function() {
		return p(u, zn(e, t, n, r, i, a, o, s, c, l));
	}, u;
}
function Bn() {
...
})), Gn = k(), Y = /* @__PURE__ */ e(h(), 1), Kn = /* @__PURE__ */ e(Vn(), 1), qn = /* @__PURE__ */ e(Hn(), 1), Jn = /* @__PURE__ */ e(Un(), 1), Yn = /* @__PURE__ */ e(Wn(), 1), Xn = (function() {
		...
		parse: /* @__PURE__ */ g(function(e) {
			...
			for (var S, C, w, T, E, D = {}, O, k, ee, A;;) {
				if (w = n[n.length - 1], this.defaultActions[w] ? T = this.defaultActions[w] : (S ??= x(), T = o[w] && o[w][S]), T === void 0 || !T.length || !T[0]) {
					var te = "";
					for (O in A = [], o[w]) this.terminals_[O] && O > d && A.push("'" + this.terminals_[O] + "'");
					te = m.showPosition ? "Parse error on line " + (c + 1) + ":\n" + m.showPosition() + "\nExpecting " + A.join(", ") + ", got '" + (this.terminals_[S] || S) + "'" : "Parse error on line " + (c + 1) + ": Unexpected " + (S == f ? "end of input" : "'" + (this.terminals_[S] || S) + "'"), this.parseError(te, {
						text: m.match,
...
var fi = /* @__PURE__ */ g(function() {
	...
	renderer: {
		...
		draw: /* @__PURE__ */ g(function(e, t, n, r) {
			...
			let d = r.db.getTasks(), f = [];
			for (let e of d) f.push(e.type);
			f = A(f);
			let p = {}, h = 2 * i.topPadding;
			if (r.db.getDisplayMode() === "compact" || i.displayMode === "compact") {
				...
				h += d.length * (i.barHeight + i.barGap);
			...
			function w(e, n, a, o, s, c, u) {
				...
				if (m.append("rect").attr("id", function(e) {
					...
					return e.milestone ? s : e.vert ? .08 * s : y(e.renderEndTime || e.endTime) - y(e.startTime);
				}).attr("height", function(e) {
					return e.vert ? d.length * (i.barHeight + i.barGap) + i.barHeight * 2 : s;
				}).attr("transform-origin", function(e, t) {
					return t = e.order, (y(e.startTime) + o + .5 * (y(e.endTime) - y(e.startTime))).toString() + "px " + (t * n + a + .5 * s).toString() + "px";
				}).attr("class", function(e) {
					let t = "";
					e.classes.length > 0 && (t = e.classes.join(" "));
					let n = 0;
					for (let [t, r] of f.entries()) e.type === r && (n = t % i.numberSectionStyles);
					let r = "";
					...
					let t = y(e.startTime), n = y(e.renderEndTime || e.endTime);
					if (e.milestone && (t += .5 * (y(e.endTime) - y(e.startTime)) - .5 * s, n = t + s), e.vert) return y(e.startTime) + o;
					let r = this.getBBox().width;
					return r > n - t ? n + r + 1.5 * i.leftPadding > u ? t + o - 5 : n + o + 5 : (n - t) / 2 + t + o;
				}).attr("y", function(e, t) {
					return e.vert ? i.gridLineStartPadding + d.length * (i.barHeight + i.barGap) + 60 : (t = e.order, t * n + i.barHeight / 2 + (i.fontSize / 2 - 2) + a);
				}).attr("text-height", s).attr("class", function(e) {
					let t = y(e.startTime), n = y(e.endTime);
					e.milestone && (n = t + s);
			...
			function k(e, t) {
				...
				v.append("g").selectAll("text").data(r).enter().append(function(e) {
					...
					for (let [t, n] of f.entries()) if (e[0] === n) return "sectionTitle sectionTitle" + t % i.numberSectionStyles;
					return "sectionTitle";
				});
			}
			g(k, "vertLabels");
