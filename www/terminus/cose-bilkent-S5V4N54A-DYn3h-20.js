...
import { t as a } from "./cytoscape.esm-AeZgTqIU.js";
...
function d(e) {
	return new Promise((t) => {
		let r = n("body").append("div").attr("id", "cy").attr("style", "display:none"), o = a({
...
async function m(e, t) {
	...
	try {
		h(e);
		let t = await d(e), n = f(t), r = p(t);
		return i.debug(`Layout completed: ${n.length} nodes, ${r.length} edges`), {
			nodes: n,
			edges: r
		};
	} catch (e) {
		throw i.error("Error in cose-bilkent layout algorithm:", e), e;
	}
}
