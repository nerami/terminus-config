import { o as e } from "./src-4Rgn0kM0.js";
import { t } from "./value-DWPACaos.js";
import { i as n, n as r, r as i, t as a } from "./defaultLocale-BbgDuMnp.js";
...
function j(e, t, n) {
	...
	return i < r ? (r = k(i, r), a = n(o, a)) : (r = k(r, i), a = n(a, o)), function(e) {
		return a(r(e));
	};
}
function M(e, t, n) {
	var r = Math.min(e.length, t.length) - 1, i = Array(r), a = Array(r), o = -1;
	for (e[r] < e[0] && (e = e.slice().reverse(), t = t.slice().reverse()); ++o < r;) i[o] = k(e[o], e[o + 1]), a[o] = n(t[o], t[o + 1]);
	return function(t) {
		var n = m(e, t, 1, r) - 1;
		return a[n](i[n](t));
	};
...
function P() {
	var n = D, r = D, i = t, a, o, c, l = O, u, d, f;
	function p() {
		var e = Math.min(n.length, r.length);
		return l !== O && (l = A(n[0], n[e - 1])), u = e > 2 ? M : j, d = f = null, m;
	}
	function m(e) {
		return e == null || isNaN(e = +e) ? c : (d ||= u(n.map(a), r, i))(a(l(e)));
	}
	return m.invert = function(t) {
		return l(o((f ||= u(r, n.map(a), e))(t)));
	}, m.domain = function(e) {
		return arguments.length ? (n = Array.from(e, E), p()) : n.slice();
	}, m.range = function(e) {
		return arguments.length ? (r = Array.from(e), p()) : r.slice();
	}, m.rangeRound = function(e) {
		return r = Array.from(e), i = s, p();
	}, m.clamp = function(e) {
		return arguments.length ? (l = e ? !0 : O, p()) : l !== O;
...
function I(e, t, n, o) {
	var s = x(e, t, n), c;
	switch (o = i(o ?? ",f"), o.type) {
		case "s":
			var l = Math.max(Math.abs(e), Math.abs(t));
			return o.precision == null && !isNaN(c = C(s, l)) && (o.precision = c), r(o, l);
		case "":
		case "e":
		case "g":
		case "p":
		case "r":
			o.precision == null && !isNaN(c = w(s, Math.max(Math.abs(e), Math.abs(t)))) && (o.precision = c - (o.type === "e"));
			break;
		case "f":
		case "%":
...
function R() {
	...
	return e.copy = function() {
		return N(e, R());
	}, o.apply(e, arguments), L(e);
}
//#endregion
export { u as a, x as i, F as n, N as r, R as t };
