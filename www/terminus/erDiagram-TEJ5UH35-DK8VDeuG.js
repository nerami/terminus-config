...
import { H as i, K as a, U as o, a as s, it as c, v as l, w as u, x as d, y as f } from "./chunk-CSCIHK7Q-B8VwERSd.js";
import { t as p } from "./channel-CsEFAz9F.js";
import { c as m, g as h } from "./chunk-5ZQYHXKU-C-8o68S6.js";
import "./chunk-O5CBEL6O-BjOhlieI.js";
import "./chunk-BSJP7CBP-zJj3cxXb.js";
import "./chunk-L5ZTLDWV-CgPgdS_4.js";
import { t as g } from "./chunk-55IACEB6-zQEXSDJq.js";
import { t as _ } from "./chunk-2J33WTMH-Rg15ml2U.js";
import "./chunk-NZK2D7GU-BRkdTJv-.js";
import "./chunk-3OPIFGDE-C5vVxeYP.js";
import "./chunk-KSCS5N6A-BVicfIjK.js";
import { r as v, t as y } from "./chunk-LZXEDZCA-dtTpuV1E.js";
...
r(C, { draw: () => w });
var w = /* @__PURE__ */ t(async function(t, r, i, a) {
	n.info("REF0:"), n.info("Drawing er diagram (unified)", r);
	let { securityLevel: o, er: s, layout: c } = d(), l = a.db.getData(), u = g(r, o);
	...
	p === "neo" ? l.markers = [
		...
		"one_or_more",
		"zero_or_more"
	], l.diagramId = r, await v(l, u), l.layoutAlgorithm === "elk" && u.select(".edges").lower();
	let m = u.selectAll("[id*=\"-background\"]");
	Array.from(m).length > 0 && m.each(function() {
		let t = e(this), n = t.attr("id").replace("-background", ""), r = u.select(`#${CSS.escape(n)}`);
		if (!r.empty()) {
