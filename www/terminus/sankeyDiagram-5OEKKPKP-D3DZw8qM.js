...
import { H as n, J as r, K as i, U as a, a as o, d as s, s as c, v as l, w as u, x as d, y as f } from "./chunk-CSCIHK7Q-AEjI_JHf.js";
import { t as p } from "./ordinal-C55HfHHp.js";
...
q.parser = q;
var J = q, Y = [], X = [], Z = /* @__PURE__ */ new Map(), oe = /* @__PURE__ */ t(() => {
	...
	nodesMap: Z,
	getConfig: /* @__PURE__ */ t(() => d().sankey, "getConfig"),
	getNodes: /* @__PURE__ */ t(() => X, "getNodes"),
	getLinks: /* @__PURE__ */ t(() => Y, "getLinks"),
	getGraph: /* @__PURE__ */ t(() => ({
	...
	return n;
}, "findCentralNodeLayer"), fe = { draw: /* @__PURE__ */ t(function(n, i, a, o) {
	let { securityLevel: c, sankey: l } = d(), u = s.sankey, f;
	c === "sandbox" && (f = e("#i" + i));
	let m = e(c === "sandbox" ? f.nodes()[0].contentDocument.body : "body"), g = c === "sandbox" ? m.select(`[id="${i}"]`) : e(`[id="${i}"]`), _ = l?.width ?? u.width, v = l?.height ?? u.width, y = l?.useMaxWidth ?? u.useMaxWidth, b = l?.nodeAlignment ?? u.nodeAlignment, x = l?.prefix ?? u.prefix, S = l?.suffix ?? u.suffix, C = l?.showValues ?? u.showValues, w = l?.nodeWidth ?? u.nodeWidth ?? 10, T = l?.nodePadding ?? u.nodePadding ?? 12, E = l?.labelStyle ?? u.labelStyle ?? "legacy", D = l?.nodeColors ?? {}, O = o.db.getGraph(), k = $[b];
	P().nodeId((e) => e.id).nodeWidth(w).nodePadding(T + (C ? 15 : 0)).nodeAlign(k).extent([[0, 0], [_, v]])(O);
	let A = de(O.nodes), j = p(h), M = /* @__PURE__ */ t((e) => D[e] ?? j(e), "getNodeColor");
	...
	let N = /* @__PURE__ */ t(({ id: e, value: t }) => C ? `${e}
${x}${Math.round(t * 100) / 100}${S}` : e, "getText"), F = /* @__PURE__ */ t((e) => E === "outlined" ? (e.layer ?? 0) < A ? {
		x: e.x0 - 6,
		anchor: "end"
	} : {
		x: e.x1 + 6,
		...
		x: e.x0 - 6,
		anchor: "end"
	}, "getLabelPosition"), I = g.append("g").attr("class", "node-labels").attr("font-size", 14), L = /* @__PURE__ */ t((e) => I.selectAll(e ? `.${e}` : "text").data(O.nodes).join("text").attr("class", e ?? null).attr("x", (e) => F(e).x).attr("y", (e) => (e.y1 + e.y0) / 2).attr("dy", `${C ? "0" : "0.35"}em`).attr("text-anchor", (e) => F(e).anchor).text(N), "appendLabel");
	...
	switch (z) {
		case "gradient":
			B = /* @__PURE__ */ t((e) => e.uid, "coloring");
			break;
		case "source":
			B = /* @__PURE__ */ t((e) => M(e.source.id), "coloring");
			break;
		case "target":
			B = /* @__PURE__ */ t((e) => M(e.target.id), "coloring");
			break;
		default: B = z;
	}
	R.append("path").attr("d", K()).attr("stroke", B).attr("stroke-width", (e) => Math.max(1, e.width)), r(void 0, g, 0, y);
}, "draw") }, pe = /* @__PURE__ */ t((e) => e.replaceAll(/^[^\S\n\r]+|[^\S\n\r]+$/g, "").replaceAll(/([\n\r])+/g, "\n").trim(), "prepareTextForParsing"), me = /* @__PURE__ */ t((e) => `.label {
