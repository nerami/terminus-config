...
import { n as t } from "./src-nrT8XS4T.js";
import { H as n, K as r, U as i, a, c as o, v as s, w as c, x as l, y as u } from "./chunk-CSCIHK7Q-B8VwERSd.js";
import { t as d } from "./arc-sowdMk1h.js";
import { t as f } from "./chunk-FMBD7UC4-BewKEE1M.js";
import { a as p, n as m, o as h, s as g } from "./chunk-ND2GUHAM-gKcBvJ4r.js";
...
var _ = (function() {
	...
	return t(u, "Parser"), u.prototype = l, l.Parser = u, new u();
})();
_.parser = _;
var v = _, y = "", b = [], x = [], S = [], C = /* @__PURE__ */ t(function() {
	b.length = 0, x.length = 0, y = "", S.length = 0, a();
}, "clear"), w = /* @__PURE__ */ t(function(e) {
	y = e, b.push(e);
}, "addSection"), T = /* @__PURE__ */ t(function() {
	return b;
}, "getSections"), E = /* @__PURE__ */ t(function() {
	let e = A(), t = 0;
	for (; !e && t < 100;) e = A(), t++;
	return x.push(...S), x;
}, "getTasks"), D = /* @__PURE__ */ t(function() {
	let e = [];
	return x.forEach((t) => {
		t.people && e.push(...t.people);
	}), [...new Set(e)].sort();
}, "updateActors"), O = /* @__PURE__ */ t(function(e, t) {
	...
	S.push(o);
}, "addTask"), k = /* @__PURE__ */ t(function(e) {
	let t = {
		section: y,
		type: y,
		description: e,
	...
	x.push(t);
}, "addTaskOrg"), A = /* @__PURE__ */ t(function() {
	let e = /* @__PURE__ */ t(function(e) {
		return S[e].processed;
	}, "compileTask"), n = !0;
	for (let [t, r] of S.entries()) e(t), n &&= r.processed;
	return n;
}, "compileTasks"), j = {
	getConfig: /* @__PURE__ */ t(() => l().journey, "getConfig"),
	clear: C,
	setDiagramTitle: r,
	getDiagramTitle: c,
	setAccTitle: i,
	...
	addTask: O,
	addTaskOrg: k,
	getActors: /* @__PURE__ */ t(function() {
		return D();
	}, "getActors")
}, M = /* @__PURE__ */ t((e) => `.label {
  ...
  ${f()}
`, "getStyles"), N = /* @__PURE__ */ t(function(e, t) {
	return p(e, t);
}, "drawRect"), P = /* @__PURE__ */ t(function(e, n) {
...
}, "drawFace"), F = /* @__PURE__ */ t(function(e, t) {
...
}, "drawCircle"), I = /* @__PURE__ */ t(function(e, t) {
	return h(e, t);
}, "drawText"), L = /* @__PURE__ */ t(function(e, n) {
	function r(e, t, n, r, i) {
		return e + "," + t + " " + (e + n) + "," + t + " " + (e + n) + "," + (t + r - i) + " " + (e + n - i * 1.2) + "," + (t + r) + " " + e + "," + (t + r);
	}
	t(r, "genPoints");
	let i = e.append("polygon");
	i.attr("points", r(n.x, n.y, 50, 20, 7)), i.attr("class", "labelBox"), n.y += n.labelMargin, n.x += .5 * n.labelMargin, I(e, n);
...
}, "drawSection"), z = -1, B = /* @__PURE__ */ t(function(e, t, n, r) {
...
}, "drawTask"), V = /* @__PURE__ */ t(function(e, t) {
	m(e, t);
	...
	initGraphics: /* @__PURE__ */ t(function(e, t) {
...
t(q, "drawActorLegend");
var J = l().journey, Y = 0, ee = /* @__PURE__ */ t(function(t, n, r, i) {
	...
	updateBounds: /* @__PURE__ */ t(function(e, n, r, i) {
		...
		function c(c) {
			return /* @__PURE__ */ t(function(t) {
				...
				o.updateVal(t, "starty", n - l * a.boxMargin, Math.min), o.updateVal(t, "stopy", i + l * a.boxMargin, Math.max), o.updateVal(X.data, "startx", e - l * a.boxMargin, Math.min), o.updateVal(X.data, "stopx", r + l * a.boxMargin, Math.max), c !== "activation" && (o.updateVal(t, "startx", e - l * a.boxMargin, Math.min), o.updateVal(t, "stopx", r + l * a.boxMargin, Math.max), o.updateVal(X.data, "starty", n - l * a.boxMargin, Math.min), o.updateVal(X.data, "stopy", i + l * a.boxMargin, Math.max));
			}, "updateItemBounds");
		}
		t(c, "updateFn"), this.sequenceItems.forEach(c());
	}, "updateBounds"),
...
}, Z = J.sectionFills, Q = J.sectionColours, te = /* @__PURE__ */ t(function(e, t, n, r) {
