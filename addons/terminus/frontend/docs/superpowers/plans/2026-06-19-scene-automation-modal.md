...
- Run `pnpm test:run` (Vitest) from `addons/terminus/frontend/`.
...
```bash
git add addons/terminus/frontend/src/lib/ha-graph/build.ts \
        addons/terminus/frontend/src/lib/ha-graph/build.test.ts
...
```bash
git add addons/terminus/frontend/src/components/graph/GraphCanvas.tsx
